...
/*
 * @(#)dds_cpp_builtintypes.h    generated by: makeheader    Thu Feb 28 22:13:03 2019
 *
...
public:                                                                  
  ...
  */
  ...
  /*e \dref_StringTypeSupport_serialize_data_to_cdr_buffer_ex
  */
...
public:                                  
    ...
    */
    ...
    /*e \dref_StringDataWriter_create_data
    */
    virtual char* create_data(
            const DDS_TypeAllocationParams_t& alloc_params);

    /*e \dref_StringDataWriter_delete_data
    */
    virtual DDS_Boolean delete_data(
            char *sample,
            const DDS_TypeDeallocationParams_t& dealloc_params);

    virtual DDS_ReturnCode_t get_loan(char *&sample);
    virtual DDS_ReturnCode_t discard_loan(char &sample);
...
public:                        
    ...
    */
    ...
    /*e \dref_OctetsTypeSupport_serialize_data_to_cdr_buffer_ex
    */
    static DDS_ReturnCode_t serialize_data_to_cdr_buffer_ex(
          char *buffer,
          unsigned int &length,
...
public:                                                              
    ...
    */
    ...
    /*e \dref_OctetsDataWriter_create_data
    */
    virtual DDS_Octets* create_data(
            const DDS_TypeAllocationParams_t& alloc_params);

    /*e \dref_OctetsDataWriter_delete_data
    */
    virtual DDS_Boolean delete_data(
            DDS_Octets *sample,
            const DDS_TypeDeallocationParams_t& dealloc_params);

    virtual DDS_ReturnCode_t get_loan(DDS_Octets *&sample);
    virtual DDS_ReturnCode_t discard_loan(DDS_Octets &sample);
...
public:                        
    ...
    */
    ...
    /*e \dref_KeyedStringTypeSupport_serialize_data_to_cdr_buffer_ex
    */
    static DDS_ReturnCode_t serialize_data_to_cdr_buffer_ex(
          char *buffer,
          unsigned int &length,
...
public:                                                              
    ...
    */
    ...
    /*e \dref_KeyedStringDataWriter_create_data
    */
    virtual DDS_KeyedString* create_data(
            const DDS_TypeAllocationParams_t& alloc_params);

    /*e \dref_KeyedStringDataWriter_delete_data
    */
    virtual DDS_Boolean delete_data(
            DDS_KeyedString *sample,
            const DDS_TypeDeallocationParams_t& dealloc_params);

    virtual DDS_ReturnCode_t get_loan(DDS_KeyedString *&sample);
    virtual DDS_ReturnCode_t discard_loan(DDS_KeyedString &sample);
...
public:                        
    ...
    */
    ...
    /*e \dref_KeyedOctetsTypeSupport_serialize_data_to_cdr_buffer_ex
    */
    static DDS_ReturnCode_t serialize_data_to_cdr_buffer_ex(
          char *buffer,
          unsigned int &length,
...
public:                                                              
    ...
    */
    ...
    /*e \dref_KeyedOctetsDataWriter_create_data
    */
    virtual DDS_KeyedOctets* create_data(
            const DDS_TypeAllocationParams_t& alloc_params);

    /*e \dref_KeyedOctetsDataWriter_delete_data
    */
    virtual DDS_Boolean delete_data(
            DDS_KeyedOctets *sample,
            const DDS_TypeDeallocationParams_t& dealloc_params);

    virtual DDS_ReturnCode_t get_loan(DDS_KeyedOctets *&sample);
    virtual DDS_ReturnCode_t discard_loan(DDS_KeyedOctets &sample);
