...
/*
 * @(#)dds_cpp_infrastructure.h    generated by: makeheader    Thu Feb 28 22:13:03 2019
 *
...
class DDSCPPDllExport DDSDataTagQosPolicyHelper {
  public:
    /*e \dref_DataTagQosPolicyHelper_get_number_of_tags
    */
    static DDS_Long get_number_of_tags(DDS_DataTagQosPolicy& policy);

    /*e \dref_DataTagQosPolicyHelper_assert_tag
    */
    static DDS_ReturnCode_t assert_tag(
            DDS_DataTagQosPolicy& policy,
            const char *name,
            const char *value);

    /*e \dref_DataTagQosPolicyHelper_add_tag
    */
    static DDS_ReturnCode_t add_tag(
            DDS_DataTagQosPolicy& policy,
            const char *name,
            const char *value);

    /*e \dref_DataTagQosPolicyHelper_lookup_tag
    */
    static struct DDS_Tag *lookup_tag(
            DDS_DataTagQosPolicy& policy,
            const char *name);

    /*e \dref_DataTagQosPolicyHelper_remove_tag
    */
    static DDS_ReturnCode_t remove_tag(
            DDS_DataTagQosPolicy& policy,
            const char *name);
};
