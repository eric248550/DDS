...
/*
 * @(#)dds_cpp_data.h    generated by: makeheader    Thu Feb 28 22:13:03 2019
 *
...
#define DDS_TYPESUPPORT_CPP_DATA_FACTORY_PUBLIC_METHODS(TTypeSupport, TData) \
...
#define DDS_TYPESUPPORT_CPP_VALUE_TYPE_PUBLIC_METHODS(TTypeSupport, TData) \
...
// Flat-data types do not support value-type semantics (copy, assign, 
// initialize, finalize); only factory functions (create and delete)
#define DDS_TYPESUPPORT_CPP_VALUE_TYPE_PUBLIC_METHODS(TTypeSupport, TData)

#endif // FLAT_DATA_TYPE

#define DDS_TYPESUPPORT_CPP_DATA_CONSTRUCTOR_PUBLIC_METHODS(TTypeSupport, TData) \
    DDS_TYPESUPPORT_CPP_DATA_FACTORY_PUBLIC_METHODS(TTypeSupport, TData) \
    DDS_TYPESUPPORT_CPP_VALUE_TYPE_PUBLIC_METHODS(TTypeSupport, TData)
...
#define DDS_DATAWRITER_WITH_DATA_CONSTRUCTOR_METHODS_CPP(TDataWriter, TData) \
                                                                     \
class NDDSUSERDllExport DDSCPPDllExport TDataWriter :                \
        public ::DDSDataWriter {                                     \
public:                                                              \
...
#define DDS_DATAREADER_CPP_PUBLIC_TYPED_METHODS(TDataReader, TDataSeq, TData)  \
...
#define DDS_DATAREADER_CPP_PRIVATE_METHODS(TDataReader, TDataSeq, TData)       \
...
class NDDSUSERDllExport DDSCPPDllExport TDataReader :                    \
  ...
  DDS_DATAREADER_CPP_PUBLIC_UNTYPED_METHODS();                           \
                                                                         \
  public:                                                                \
  DDS_DATAREADER_CPP_PUBLIC_TYPED_METHODS(TDataReader, TDataSeq, TData); \
                                                                         \
  private:                                                               \
  DDS_DATAREADER_CPP_PRIVATE_METHODS(TDataReader, TDataSeq, TData);      \
  protected:                                                             \
                                                                         \
...
class NDDSUSERDllExport DDSCPPDllExport TDataReader :                    \
  ...
  DDS_DATAREADER_CPP_PUBLIC_TYPED_METHODS(TDataReader, TDataSeq, TData); \
                                                                         \
  virtual DDS_ReturnCode_t is_data_consistent(                           \
