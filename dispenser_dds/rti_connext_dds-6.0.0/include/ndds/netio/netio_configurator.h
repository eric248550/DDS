...
/*
 * @(#)netio_configurator.h    generated by: makeheader    Thu Feb 28 22:12:10 2019
 *
...
extern RTINetioDllExport RTIBool
RTINetioConfiguratorUtil_generateShmemUuid(
               NDDS_Transport_Address_t *shmemUuidOut,
               NDDS_Transport_ClassId_t transportClassIdIn,
               RTI_UINT32 rtpsHostIdIn);
...
extern RTINetioDllExport
NDDS_Transport_Plugin* RTINetioConfiguratorUtil_setupShmemPlugin(
        struct REDAWeakReference *pluginHandleOut,
        NDDS_Transport_Address_t *networkAddressIn,
        struct RTINetioConfigurator *configuratorIn,
        struct RTIClock *clockIn,
        struct RTINetioAliasList *aliasListIn,
...
extern RTINetioDllExport
NDDS_Transport_Plugin* RTINetioConfiguratorUtil_setupShmemPluginI(
        struct REDAWeakReference *pluginHandleOut,
        NDDS_Transport_Address_t *networkAddressIn,
        struct RTINetioConfigurator *configuratorIn,
        struct RTIClock *clockIn,
        struct RTINetioAliasList *aliasListIn,
        struct NDDS_Transport_Shmem_Property_t *propertyIn,
        struct RTINetioAddressFilter *serviceAddresRangeIn,
        struct REDAWorker *worker);
...
#include "netio/netio_configurator_impl.h"
