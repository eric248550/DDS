...
/*
 * @(#)disc_builtin.h    generated by: makeheader    Thu Feb 28 22:12:46 2019
 *
...
#define disc_builtin_h
    ...
    #include "osapi/osapi_compression.h"
#endif
...
#define DISC_BUILTIN_ENDPOINT_PARTICIPANT_SECURE_ANNOUNCER \
    MIG_RTPS_BUILTIN_ENDPOINT_SECURE_RELIABLE_PARTICIPANT_WRITER
#define DISC_BUILTIN_ENDPOINT_PARTICIPANT_SECURE_DETECTOR \
    MIG_RTPS_BUILTIN_ENDPOINT_SECURE_RELIABLE_PARTICIPANT_READER
...
#define DISC_BUILTIN_TOPIC_PARTICIPANT_SECURE           "DISCParticipantSecure"
...
#define DISC_BUILTIN_DATA_TAG_LIST_MAX_LENGTH_NAME "DiscBuiltinDataTagListMaxLength"
#define DISC_BUILTIN_DATA_TAG_STRING_MAX_LENGTH_NAME "DiscBuiltinDataTagStringMaxLength"
...
#define DISC_BUILTIN_TYPE_OBJECT_LB_SERIALIZATION_THRESHOLD_NAME "DiscBTOLST"
...
#define DISC_BUILTIN_LB_SERIALIZATION_CLASS_ID_NAME "DiscLBID"
...
#define DISC_BUILTIN_PUBLICATION_PROPERTY_LENGTH (18)
...
strlen(DISC_BUILTIN_TYPE_OBJECT_LB_SERIALIZATION_THRESHOLD_NAME) +                \
strlen(DISC_BUILTIN_PROPERTY_LIST_MAX_LENGTH_NAME) +                              \
strlen(DISC_BUILTIN_PROPERTY_STRING_MAX_LENGTH_NAME) +                            \
strlen(DISC_BUILTIN_DATA_TAG_LIST_MAX_LENGTH_NAME) +                              \
strlen(DISC_BUILTIN_DATA_TAG_STRING_MAX_LENGTH_NAME) +                            \
...
DISCBuiltin_createEndpointProperties(
    ...
    int propertyListMaximumLength,
    int propertyStringMaximumLength,
    int dataTagListMaximumLength,
    int dataTagStringMaximumLength,
    int maxPartitions,
...
struct DISCBuiltinTopicSubscriptionDataPool {
    ...
    int _typeObjectLbSerializationThreshold;
    int _userDataMaximumLength;
