...
/*
 * @(#)writer_history_interface.h    generated by: makeheader    Thu Feb 28 22:12:30 2019
 *
...
struct NDDS_WriterHistory_Property {
    ...
    */
    ...
    /*e
     * \brief Indicates if the auto purge delays are applied based on
     * source timestamp or current time
     */
    RTIBool sourceTimestampBasedAutopurgeInstancesDelay;
...
#define WRITER_HISTORY_PROPERTY_DEFAULT { \
    ...
    RTI_FALSE, /* sourceTimestampBasedAutopurgeInstancesDelay */ \
...
struct NDDS_WriterHistory_Instance {
    ...
    */
    ...
    /*e
      \brief True if the instance is disposed; false if it's alive
    */
    RTIBool disposed;
...
struct NDDS_WriterHistory_AllocatorParams {
    RTIEncapsulationId encapsulationId;
    NDDS_WriterHistory_SampleKind sampleKind;
};


#define NDDS_WriterHistory_AllocatorParams_INITIALIZER { \
    RTI_CDR_ENCAPSULATION_ID_CDR_NATIVE, \
    NDDS_WRITERHISTORY_DATA_SAMPLE \
}
...
typedef int (*NDDS_WriterHistory_Allocator_getBufferWithParams_fn)(
    NDDS_WriterHistory_AllocatorHandle handle,
    struct REDABuffer *buffer,
    const void *user_data,
    const struct NDDS_WriterHistory_AllocatorParams *params);
...
typedef int (*NDDS_WriterHistory_Allocator_returnBufferWithParams_fn)(
    NDDS_WriterHistory_AllocatorHandle handle,
    struct REDABuffer *buffer,
    const struct NDDS_WriterHistory_AllocatorParams *params);
...
struct NDDS_WriterHistory_Allocator {
    /* Optional */
    NDDS_WriterHistory_Allocator_newAllocator_fn        newAllocator;
    /* Optional */
    NDDS_WriterHistory_Allocator_deleteAllocator_fn     deleteAllocator;
    /* Mandatory to have either getBuffer_fn or getBufferWithParams_fn */
    NDDS_WriterHistory_Allocator_getBuffer_fn           getBuffer;
    NDDS_WriterHistory_Allocator_getBufferWithParams_fn getBufferWithParams;
    /* Mandatory to have either returnBuffer_fn or returnBufferWithParams_fn */
    NDDS_WriterHistory_Allocator_returnBuffer_fn        returnBuffer;
...
typedef RTI_INT32 (*NDDS_WriterHistory_Plugin_PruneExpiredSamplesFcn)(
    struct NDDS_WriterHistory_Plugin * self,
    RTIBool * samples_reusable_out,
    NDDS_WriterHistory_Handle history_in,
    const struct RTINtpTime *now_in,
...
typedef RTI_INT32 (*NDDS_WriterHistory_Plugin_GetSerializationBufferWithParamsFcn)(
    struct NDDS_WriterHistory_Plugin *self,
...
typedef RTI_INT32 (*NDDS_WriterHistory_Plugin_ReturnSerializationBufferWithParamsFcn)(
    struct NDDS_WriterHistory_Plugin *self,
...
struct NDDS_WriterHistory_Plugin {
    ...
    */
    ...
    /*e @brief Prunes WH expired samples.
    */
    NDDS_WriterHistory_Plugin_PruneExpiredSamplesFcn prune_expired_samples;
    ...
    */
    ...
    /*e
    */
    NDDS_WriterHistory_Plugin_GetSerializationBufferWithParamsFcn get_serialization_buffer_w_params;
    /*e
    */
    NDDS_WriterHistory_Plugin_ReturnSerializationBufferWithParamsFcn return_serialization_buffer_w_params;
    /*e
    */
