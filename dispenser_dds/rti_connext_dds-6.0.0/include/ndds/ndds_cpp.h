...
/*
 * @(#)ndds_cpp.h    generated by: makeheader    Thu Feb 28 22:15:37 2019
 *
...
/* Must be VS2003 or greater, and not compiling for WinCE */
#if defined(_WIN32) && !defined(RTI_WINCE) && !defined(RTI_INTIME) && _MSC_VER > 1310 && !defined(RTI_WIN32)
	#define RTI_WIN32
    ...
    #include "ndds/dds_cpp/dds_cpp_interpreter.h"
  #endif
