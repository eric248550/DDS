...
/*
 * @(#)cdr_stream_impl.h    generated by: makeheader    Thu Feb 28 22:11:48 2019
 *
...
#define RTICdrStream_serialize4ByteTypedFastMacro(me, in, type) \
    (((me)->_needByteSwap) ?                              \
     (void)(                                              \
     ...
     (void)(                                              \
      *(type *)((me)->_currentPosition) = *(in),   \
      (me)->_currentPosition += RTI_CDR_LONG_SIZE         \
     )                                                    \
    )

#define RTICdrStream_serialize4ByteFastMacro(me, in) \
  RTICdrStream_serialize4ByteTypedFastMacro(me, in, RTICdr4Byte)

#define RTICdrStream_deserialize4ByteTypedFastMacro(me, out, type) \
    (((me)->_needByteSwap) ?                              \
     (void)(                                              \
     ...
     (void)(                                              \
      *(out) = *(type *)((me)->_currentPosition),  \
      (me)->_currentPosition += RTI_CDR_LONG_SIZE         \
     )                                                    \
    )

#define RTICdrStream_deserialize4ByteFastMacro(me, out) \
  RTICdrStream_deserialize4ByteTypedFastMacro(me, out, RTICdr4Byte)
...
#define RTICdrStream_skipBitsAndGetLength(me, bitSize)                \
   ...
   #define RTICdrStream_serializeFloatFast(me, in) \
     RTICdrStream_serialize4ByteTypedFastMacro(me, (const RTICdrFloat *) (in), RTICdrFloat)

   #define RTICdrStream_deserializeFloatFast(me, out) \
     RTICdrStream_deserialize4ByteTypedFastMacro(me, (RTICdrFloat *) (out), RTICdrFloat)
  ...
  #define RTICdrStream_serializeFloat(me, in) \
    ((RTICdrStream_align(me, 4) \
      && RTICdrStream_checkSize(me, 4)) \
      ? (RTICdrStream_serializeFloatFast(me, in), \
      RTI_TRUE) : RTI_FALSE)

  #define RTICdrStream_deserializeFloat(me, in) \
    ((RTICdrStream_align(me, 4) \
      && RTICdrStream_checkSize(me, 4)) \
      ? (RTICdrStream_deserializeFloatFast(me, in), \
      RTI_TRUE) : RTI_FALSE)
  ...
  #define RTICdrStream_serializeEnum(me, in) \
    ((RTICdrStream_align(me, 4) \
      && RTICdrStream_checkSize(me, 4)) \
      ? (RTICdrStream_serialize4ByteFastMacro(me, in), \
      RTI_TRUE) : RTI_FALSE)

  #define RTICdrStream_deserializeEnum(me, in) \
    ((RTICdrStream_align(me, 4) \
      && RTICdrStream_checkSize(me, 4)) \
      ? (RTICdrStream_deserialize4ByteFastMacro(me, in), \
      RTI_TRUE) : RTI_FALSE)
...
((RTICdrEncapsulation_isBigEndianCdrEncapsulationId((me)->_encapsulationKind) \
  && (me)->_endian != RTI_CDR_ENDIAN_BIG) ? \
((me)->_endian = RTI_CDR_ENDIAN_BIG, \
  (me)->_needByteSwap = ((me)->_nativeEndian == RTI_CDR_ENDIAN_BIG) ? RTI_FALSE : RTI_TRUE, RTI_TRUE) : \
((RTICdrEncapsulation_isLittleEndianCdrEncapsulationId((me)->_encapsulationKind) \
  && (me)->_endian != RTI_CDR_ENDIAN_LITTLE) ? \
  ((me)->_endian = RTI_CDR_ENDIAN_LITTLE, \
   (me)->_needByteSwap = ((me)->_nativeEndian == RTI_CDR_ENDIAN_BIG) ? RTI_TRUE : RTI_FALSE, RTI_TRUE) : \
  (RTICdrEncapsulation_validCdrEncapsulationId((me)->_encapsulationKind) \
  ? RTI_TRUE : RTI_FALSE)))
...
((((me)->_encapsulationKind == RTI_CDR_ENCAPSULATION_ID_PL_CDR_BE \
    || (me)->_encapsulationKind == RTI_CDR_ENCAPSULATION_ID_PL_CDR2_BE) \
  && (me)->_endian != RTI_CDR_ENDIAN_BIG) ? \
 ((me)->_endian = RTI_CDR_ENDIAN_BIG, \
  (me)->_needByteSwap = ((me)->_nativeEndian == RTI_CDR_ENDIAN_BIG) ? RTI_FALSE : RTI_TRUE, RTI_TRUE) : \
 ((((me)->_encapsulationKind == RTI_CDR_ENCAPSULATION_ID_PL_CDR_LE \
    || (me)->_encapsulationKind == RTI_CDR_ENCAPSULATION_ID_PL_CDR2_LE) \
  && (me)->_endian != RTI_CDR_ENDIAN_LITTLE) ? \
  ((me)->_endian = RTI_CDR_ENDIAN_LITTLE, \
   (me)->_needByteSwap = ((me)->_nativeEndian == RTI_CDR_ENDIAN_BIG) ? RTI_TRUE : RTI_FALSE, RTI_TRUE) : \
  (RTICdrEncapsulation_validParameterCdrEncapsulationId((me)->_encapsulationKind) \
  ? RTI_TRUE : RTI_FALSE)))
...
( \
  /* if */ RTICdrEncapsulation_isBigEndianCdrEncapsulationId(encapsulationId) ? \
 \
 ...
 \
  /* else if */ : (RTICdrEncapsulation_isLittleEndianCdrEncapsulationId(encapsulationId) ? \
 \
...
(RTICdrEncapsulation_validPlainCdrEncapsulationId(kind)) ? \
((kind) == RTI_CDR_ENCAPSULATION_ID_CDR_LE || (kind) == RTI_CDR_ENCAPSULATION_ID_CDR2_LE ?  \
...
#define RTICdrStream_asXCdrStream(me) (struct RTIXCdrStream *)me
