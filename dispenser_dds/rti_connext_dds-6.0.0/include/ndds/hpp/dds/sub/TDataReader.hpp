...
public:
    ...
    public:
        ...
        /**
         * @brief Read samples, inserting them into a provided container
         * 
        ...
        /**
         * @brief Take samples, inserting them into a provided container
         * 
         * @tparam SamplesBIIterator A back-inserting iterator whose value type 
         * is dds::sub::Sample<T> 
         * @param sbit A back-inserting iterator placed at the position in the 
...
public:
     ...
     * 
     * 
     * @note This function should not be confused with \ref read(T& sample),
     * an extension function that reads a single sample and assigns it to 
     * the argument.
     * 
     * @see read() 
     * @see \ref DDSReaderExampleModule_receive 
     ...
     * 
     * @note This function should not be confused with \ref take(T& sample),
     * an extension function that takes a single sample and assigns it to 
     * the argument.
     * 
     * @see take() 
     * @see \ref DDSReaderExampleModule_receive 
