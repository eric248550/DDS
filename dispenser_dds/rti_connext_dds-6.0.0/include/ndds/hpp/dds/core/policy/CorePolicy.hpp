...
typedef dds::core::policy::detail::DataRepresentation DataRepresentation;
typedef dds::core::policy::detail::TypeConsistencyEnforcement TypeConsistencyEnforcement;
#endif

#ifdef OMG_DDS_SECURITY_SUPPORT
typedef dds::core::policy::detail::DataTag DataTag;
#endif

// --- Policy-traits definitions: ---------------------------------------------
...
#ifdef OMG_DDS_SECURITY_SUPPORT
OMG_DDS_POLICY_TRAITS(DataTag, 25)
#endif
