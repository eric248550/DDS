...
public:
  ...
  public:
    ...
    */
     ...
     *
     * @tparam OctetIter An input iterator of bytes (convertible to uint8_t).
     *
...
/**
 * @RTI_class_definition class DataRepresentation
 * @headerfile dds/core/policy/CorePolicy.hpp
 * @brief Contains the data representations supported by entities
 *
 * @details \dref_details_DataRepresentationQosPolicy
 */
template <typename D>
...
public:
    ...
    OMG_DDS_VALUE_TYPE_DEFINE_DEFAULT_MOVE_OPERATIONS(
        TDataRepresentation, D)

    /**
     * @brief Extended Common Data Representation encoding version 1
     * 
     * @details \dref_details_XCDR_DATA_REPRESENTATION
     */
    ...
    /**
     * @brief XML Data Representation (unsupported)
     * 
     * @details \dref_details_XML_DATA_REPRESENTATION
     */
    ...
    /**
     * @brief Extended Common Data Representation encoding version 2
     * 
     * @details \dref_details_XCDR2_DATA_REPRESENTATION
     */
    ...
    /**
     * @brief Representation automatically chosen based on the type
     * 
     * @details \dref_details_AUTO_DATA_REPRESENTATION
     */
    ...
    /**
     * @brief Creates an instance with one element, auto_id().
     */
    TDataRepresentation() : dds::core::Value<D>()
    {
    }

    /**
     * @brief Creates an instance with a sequence of DataRepresentationId
     *
     * @param seq A vector containing the DataRepresentationIds to
     * create this DataRepresentation
     */
    explicit TDataRepresentation(const DataRepresentationIdSeq& seq)
        : Value<D>(seq)
    {
    }
     ...
     * @brief Creates an instance with a sequence of DataRepresentationId
     *
     * @param value_begin Beginning of a range of DataRepresentationId
     * @param value_end End of the range
     */
    TDataRepresentation(
    ...
    /**
     * @brief Sets the DataRepresentationId sequence
     *
     * @tparam ShortIter An input iterator of DataRepresentationId.
     *
     * @param the_begin Beginning of the range
     * @param the_end End of the range
     */
    template <typename ShortIter>
    TDataRepresentation& value(ShortIter the_begin, ShortIter the_end)
    {
        this->delegate().value(the_begin, the_end);
        return *this;
    }
    ...
    /**
     * @brief Gets the DataRepresentation.
     *
     * @return the sequence of DataRepresentationId representing the data
     * representations
     */
    ...
    /**
     * @brief Gets the data representation.
     *
     * @param dest The vector where the DataRepresentationId will be copied
     * @return A reference to \p dest
     */
    DataRepresentationIdSeq& value(DataRepresentationIdSeq& dest) const
    {
        return this->delegate().value(dest);
    }
};
...
public:
    ...
    /**
     * @brief Controls whether sequence bounds are ignored
     *
     * @details \dref_details_TypeConsistencyEnforcementQosPolicy_ignore_sequence_bounds
     */
    TTypeConsistencyEnforcement& ignore_sequence_bounds(bool ignore)
    {
        this->delegate().ignore_sequence_bounds(ignore);
        return *this;
    }
    ...
    /**
     * @brief Controls whether string bounds are ignored
     * 
     * @details 
     *          \dref_details_TypeConsistencyEnforcementQosPolicy_ignore_string_bounds
     */
    TTypeConsistencyEnforcement& ignore_string_bounds(bool ignore)
    {
        this->delegate().ignore_string_bounds(ignore);
        return *this;
    }
    ...
    /**
     * @brief Controls whether member names are ignored
     * 
     * @details 
     *          \dref_details_TypeConsistencyEnforcementQosPolicy_ignore_member_names
     */
    TTypeConsistencyEnforcement& ignore_member_names(bool ignore)
    {
        this->delegate().ignore_member_names(ignore);
        return *this;
    }
    ...
    /**
     * @brief Controls whether type widening is prevented
     * 
     * @details 
     *          \dref_details_TypeConsistencyEnforcementQosPolicy_prevent_type_widening
     */
    TTypeConsistencyEnforcement& prevent_type_widening(bool prevent)
    {
        this->delegate().prevent_type_widening(prevent);
        return *this;
    }
    ...
    /**
     * @brief Controls whether type validation is forced
     * 
     * @details 
     *          \dref_details_TypeConsistencyEnforcementQosPolicy_force_type_validation
     */
    TTypeConsistencyEnforcement& force_type_validation(bool force)
    {
        this->delegate().force_type_validation(force);
        return *this;
    }
    ...
    /**
     * @brief Controls whether enumeration literal names are ignored
     * 
     * @details 
     *          \dref_details_TypeConsistencyEnforcementQosPolicy_ignore_enum_literal_names
     */
    TTypeConsistencyEnforcement& ignore_enum_literal_names(bool ignore)
    {
        this->delegate().ignore_enum_literal_names(ignore);
        return *this;
    }
    ...
    {
        return this->delegate().ignore_enum_literal_names();
    }
     ...
     */
    static TTypeConsistencyEnforcement AutoTypeCoercion()
    {
        return TTypeConsistencyEnforcement(
           dds::core::policy::TypeConsistencyEnforcementKind::AUTO_TYPE_COERCION);
    }
};
/** @RTI_remove_lines 1 */
#endif 
...
/** @RTI_remove_lines 1 */
#ifdef OMG_DDS_SECURITY_SUPPORT

/** 
 * @RTI_class_definition class DataTag
 * @headerfile dds/core/policy/CorePolicy.hpp 
 * @brief Stores name-value (string) pairs that can be used to 
 *        determine access permissions.
 * @details \dref_details_DataTagQosPolicy
 */
template <typename D>
class TDataTag : public dds::core::Value<D> {
public:
    /**
    ...
    OMG_DDS_VALUE_TYPE_DEFINE_DEFAULT_MOVE_OPERATIONS(TDataTag, D)

    /**
     * @brief Creates a policy with an empty sequence of tags
     */
    TDataTag() : dds::core::Value<D>() 
    { 
    }
    ...
    TDataTag(EntryIter begin, EntryIter end)
    {
        set(begin, end);
    }
     ...
     * that comes last.
     */
    TDataTag(std::initializer_list<Entry> entries)
    {
        set(entries);
    }
    ...
    {
        return this->delegate().try_get(key);
    }

    /**
     * @brief Adds or assigns a tag from a pair of strings
     *
     * If the key doesn't exist it adds the new entry. Otherwise it
     * overrides its value with the new one.
     *
     * @param tag \p tag.first is the key and \p
     *          tag.second is the value
     */
    TDataTag& set(const Entry& tag)
    {
     ...
     */
    template <typename EntryIter>
    TDataTag& set(EntryIter begin, EntryIter end)
    {
        this->delegate().set(begin, end);
        return *this;
    }
