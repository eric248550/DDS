...
public:
     ...
     */
    virtual void on_destination_unreachable(
        dds::pub::DataWriter<T>&,
        const dds::core::InstanceHandle&,
        const rti::core::Locator&) = 0;


    /**
     * @brief @extension No-op
     */
    virtual void* on_data_request(
        dds::pub::DataWriter<T>&,
        const rti::core::Cookie&) = 0;


    /**
     * @brief @extension No-op
     */
    virtual void on_data_return(
        dds::pub::DataWriter<T>&,
        void*,
        const rti::core::Cookie&) = 0;
    ...
    /**
     * @brief @extension Called when a sample is removed from the DataWriter
     * queue.
     *
     * @details \dref_details_DataWriterListener_on_sample_removed
     *
     */
