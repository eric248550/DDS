...
/** @RTI_remove_lines 1 */
    ...
    /**
     * @brief Get the dds::core::policy::DataRepresentation policy
     * of the corresponding dds::topic::Topic
     * 
     * @return The DataRepresentation policy
     */
...
/** @RTI_remove_lines 1 */
    ...
    /**
     * @brief Get the dds::core::policy::DataRepresentation policy
     * of the corresponding dds::pub::DataWriter
     * 
     * @return The DataRepresentation policy
     */
    const dds::core::policy::DataRepresentation& representation() const
    ...
    /**
     * @brief Get the dds::core::policy::DataTag policy of the
     * corresponding dds::pub::DataWriter
     * 
     * @return The DataTag policy
     */
    const dds::core::policy::DataTag& data_tag() const
    {
        return this->delegate().data_tag();
    }
...
public:
    ...
    /**
     * @brief Get the dds::core::policy::DataRepresentation policy
     * of the corresponding dds::sub::DataReader
     * 
     * @return The DataRepresentation policy
     */
    const dds::core::policy::DataRepresentation& representation() const
