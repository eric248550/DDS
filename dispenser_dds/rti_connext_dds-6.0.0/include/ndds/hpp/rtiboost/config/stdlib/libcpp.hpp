...
// Modified by RTI
// This was done for INtime port (PLATFORMS-1372) because intime uses 
// libc++ std library which  has _cplusplus set to = 199711 and compiled
// in VS 2017 Version 15.7.4 / .NET version 4.7.03056
