...
XMQCPP2DllExport
void set_role_name(dds::pub::qos::DataWriterQos& qos, const std::string& role_name);

XMQCPP2DllExport
void set_role_name(dds::sub::qos::DataReaderQos& qos, const std::string& role_name);
