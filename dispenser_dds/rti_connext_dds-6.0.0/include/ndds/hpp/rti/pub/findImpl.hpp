 ...
 *
 * @tparam Writer The type of the writer. It can be dds::pub::AnyDataWriter, or
 * an instantiation of dds::pub::DataWriter<T> (if T is not the correct
 ...
 *
 * @see DDSWriterExampleModule_lookup
 */
 ...
 * dds::pub::Publisher
 * 
 * @tparam AnyDataWriterBackInsertIterator An iterator whose \p value_type
 * is \p dds::pub::AnyDataWriter
 ...
 * dds::pub::Publisher
 * 
 * @tparam AnyDataWriterForwardIterator An iterator whose \p value_type
 * is \p dds::pub::AnyDataWriter
 *
 * @param publisher The dds::pub::Publisher the DataWriters belong to
 * @param begin A forward iterator to the first position in the destination container
 * to copy the found DataWriters into
