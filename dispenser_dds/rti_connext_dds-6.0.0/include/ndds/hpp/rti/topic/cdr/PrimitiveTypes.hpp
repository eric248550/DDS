...
struct wchar_serialization_impl {
    ...
    {
        DDS_Wchar tmp = static_cast<DDS_Wchar>(*v);
        RTICdrStream_serializeWcharFast(stream, &tmp);
        return true;
    }
    static bool deserialize_fast(RTICdrStream *stream, wchar_t *v)
    {
        DDS_Wchar tmp;
        RTICdrStream_deserializeWcharFast(stream, &tmp);
        *v = static_cast<wchar_t>(tmp);
        return true;
    }
};
...
struct wchar_serialization_impl<sizeof(DDS_Wchar)> {
    static bool serialize(RTICdrStream *stream, const wchar_t *v)
    {
        return RTICdrStream_serializeWchar(stream, reinterpret_cast<const DDS_Wchar*>(v));
    }

    static bool deserialize(RTICdrStream *stream, wchar_t *v)
    {
        return RTICdrStream_deserializeWchar(
                stream,
                reinterpret_cast<DDS_Wchar*>(v));
    }

    static bool serialize_fast(RTICdrStream *stream, const wchar_t *v)
    {
        RTICdrStream_serializeWcharFast(stream, reinterpret_cast<const DDS_Wchar*>(v));
        return true;
    }

    static bool deserialize_fast(RTICdrStream *stream, wchar_t *v)
    {
        RTICdrStream_deserializeWcharFast(
                stream,
                reinterpret_cast<DDS_Wchar*>(v));
        return true;
    }
...
struct primitive_type_traits<wchar_t> {
    ...
    static bool serialize_fast(RTICdrStream *stream, const wchar_t *v)
    {
        return wchar_serialization_impl<sizeof(wchar_t)>::serialize_fast(stream, v);
    }
    static bool deserialize_fast(RTICdrStream *stream, wchar_t *v)
    {
        return wchar_serialization_impl<sizeof(wchar_t)>::deserialize_fast(stream, v);
    }
};
