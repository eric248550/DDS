...
private:
    ...
    dds::core::policy::DataRepresentation representation_;
...
public:
     ...
     * @brief Get the publication data representation.
     * 
     * @return The dds::core::policy::DataRepresentation policy of 
    ...
    const dds::core::policy::DataTag& data_tags() const
    {
        return data_tags_;
    }
...
private:
    ...
    */
    ...
    dds::core::policy::DataTag data_tags_;
