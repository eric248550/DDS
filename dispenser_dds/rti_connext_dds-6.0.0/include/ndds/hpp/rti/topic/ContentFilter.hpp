 ...
 * @brief @extension The name of the built-in SQL filter
 *
 * This filter can be used with a dds::topic::ContentFilteredTopic and
 * a rti::core::policy::MultiChannel-enabled dds::pub::DataWriter.
 *
 * @see dds::topic::Filter::name()
 * @see rti::core::policy::MultiChannel::filter_name()
 */
OMG_DDS_API std::string sql_filter_name();

/** 
 * @ingroup DDSTopicEntityModule
 * @brief @extension The name of the built-in StringMatch filter
 *
 * This filter can be used with a dds::topic::ContentFilteredTopic and
 * a rti::core::policy::MultiChannel-enabled dds::pub::DataWriter.
 *
