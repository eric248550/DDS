...
/*
 * @(#)osapi_bufferUtils_impl.h    generated by: makeheader    Thu Feb 28 22:11:21 2019
 *
...
#define osapi_bufferUtils_impl_h
  ...
  #include <string.h>
    ...
    #define RTIOsapiMemory_copy(to, src, size) \
        if((size) != 0) bcopy((const char *)src, (char *)to, size)
    ...
    #define RTIOsapiMemory_copy(to, src, size) if((size) != 0) memcpy(to, src, (size_t) (size))
    #define RTIOsapiMemory_move(to, src, size) if((size) != 0) memmove(to, src, (size_t) (size))
    #define RTIOsapiMemory_zero(m, size) memset(m, 0, (size_t) (size))
    #define RTIOsapiMemory_compare(l, r, size) \
        (((size) == 0) ? 0 : memcmp(l, r, (size_t) (size)))
