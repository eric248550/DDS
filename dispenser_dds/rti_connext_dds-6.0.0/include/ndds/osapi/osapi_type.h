...
/*
 * @(#)osapi_type.h    generated by: makeheader    Thu Feb 28 22:11:22 2019
 *
 *		built from:	type.ifc
 */
...
/* This definition is kept here to guarantee backward compatibility if the
 * user is already using RTI_CDR_SIZEOF_LONG_DOUBLE to activate native
 * long double support
 */
#if (RTI_CDR_SIZEOF_LONG_DOUBLE == 16)
  #ifndef RTI_OSAPI_SIZEOF_LONG_DOUBLE
    #define RTI_OSAPI_SIZEOF_LONG_DOUBLE 16
  #endif
#endif

#if (RTI_OSAPI_SIZEOF_LONG_DOUBLE == 16)
  typedef long double RTI_DOUBLE128;
#else
  typedef struct RTI_DOUBLE128 {
      char bytes[16];
  } RTI_DOUBLE128;
#endif /* RTI_OSAPI_SIZEOF_LONG_DOUBLE == 16 */


#define RTI_UINT8_MAX 255
#define RTI_UINT8_MIN 0

#define RTI_INT16_MAX 32767
#define RTI_INT16_MIN (-32767 - 1)

#define RTI_UINT16_MAX 65535
#define RTI_UINT16_MIN 0
...
#define RTI_FLOAT_MAX  3.4E38F
#define RTI_FLOAT_MIN  (-RTI_FLOAT_MAX)

#define RTI_DOUBLE_MAX  +1.7E+308
#define RTI_DOUBLE_MIN  (-RTI_DOUBLE_MAX)
