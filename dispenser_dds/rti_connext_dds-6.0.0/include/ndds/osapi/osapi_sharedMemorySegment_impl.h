...
/*
 * @(#)osapi_sharedMemorySegment_impl.h    generated by: makeheader    Thu Feb 28 22:11:22 2019
 *
...
struct RTIOsapiSharedMemorySegmentHeader {
	...
	guarantee an unique ID for each process.
        ...
        For non-VxWorks 64-bit platforms we keep using a
     ...
     */
#if defined(RTI_VXWORKS) && defined(RTI_64BIT)
    RTI_UINT64 ownerPid;
#else
    RTI_UINT32 ownerPid;
#endif
