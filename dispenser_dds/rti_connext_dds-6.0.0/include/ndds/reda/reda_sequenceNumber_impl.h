...
/*
 * @(#)reda_sequenceNumber_impl.h    generated by: makeheader    Thu Feb 28 22:11:31 2019
 *
...
#define REDASequenceNumber_fromLongLong(sn, src) \
    RTIOsapiUtility_assignValueFromDereference( \
            (sn)->low, \
            src, \
            unsigned int); \
    RTIOsapiUtility_assignValueFromDereference( \
...
#define REDASequenceNumber_toLongLong(dst, sn) \
    RTIOsapiUtility_assignDereferenceFromValue( \
            dst, \
            (sn)->low, \
            unsigned int); \
    RTIOsapiUtility_assignDereferenceFromValue( \
