...
/*
 * @(#)reda_inlineList.h    generated by: makeheader    Thu Feb 28 22:11:32 2019
 *
...
extern REDADllExport
struct REDAInlineListNode * REDAInlineList_moveNodeToList(
        struct REDAInlineList *dstList,
        struct REDAInlineList *srcList,
        struct REDAInlineListNode *node);

extern REDADllExport
struct REDAInlineListNode * REDAInlineList_moveNodeToListFront(
        struct REDAInlineList *dstList,
        struct REDAInlineList *srcList,
        struct REDAInlineListNode *node);

extern REDADllExport
void REDAInlineList_moveAllNodesToListFront(
        struct REDAInlineList *dstList,
        struct REDAInlineList *srcList);

extern REDADllExport
void REDAInlineList_moveFrontNodesToList(
        struct REDAInlineList *dstList,
        struct REDAInlineList *srcList,
        unsigned int nodeCount);

extern REDADllExport
struct REDAInlineListNode *REDAInlineListNode_getNext(
        const struct REDAInlineListNode *node);

extern REDADllExport
struct REDAInlineListNode *REDAInlineListNode_getPrev(
        const struct REDAInlineListNode *node);
