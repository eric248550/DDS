...
/*
 * @(#)pres_writerHistoryDriver.h    generated by: makeheader    Thu Feb 28 22:12:37 2019
 *
...
#define PRES_WRITER_HISTORY_SOURCE_TIMESTAMP_BASED_AUTOPURGE_PROPERTY "dds.data_writer.history.source_timestamp_based_autopurge_instances_delay"

#define PRES_WRITER_HISTORY_USE_530_ENCODING_ALIGNMENT_PROPERTY "dds.data_writer.history.use_530_encoding_alignment"
...
#define PRESWriterHistoryDriverUnblockListenerStorage_INITIALIZER \
    {{NULL, NULL, NULL, NULL}}
...
struct PRESWriterHistoryDriverProperty {
    ...
    */
    ...
    /* SEC-214: 530 does not align before encoding */
    RTIBool use530EncodingAlignment;
  ...
  #define PRES_WRITER_HISTORY_DRIVER_PROPERTY_DEFAULT { \
    ...
    RTI_FALSE, /* use530EncodingAlignment */ \
    NULL, /* keyMaterialKey */ \
...
typedef void *
(*PRESWriterHistoryDriverListener_OnDataRequestCallback)(
        struct PRESWriterHistoryDriverListener *self,
        struct REDABuffer *cookie,
        struct PRESWriterHistoryDriverListenerStorage *storage);

typedef void
(*PRESWriterHistoryDriverListener_OnDataReturnCallback)(
        struct PRESWriterHistoryDriverListener *self,
        void *instanceData,
        struct REDABuffer *cookie,
        struct PRESWriterHistoryDriverListenerStorage *storage);
...
struct PRESWriterHistoryDriverListener {
    ...
    PRESWriterHistoryDriverListener_OnDataRequestCallback onDataRequest;
    PRESWriterHistoryDriverListener_OnDataReturnCallback onDataReturn;
};
...
extern PRESDllExport RTIBool
PRESWriterHistoryDriver_pruneExpiredEntries(
    struct PRESWriterHistoryDriver *me,
...
extern PRESDllExport
RTIBool PRESWriterHistoryDriver_returnSerializationBufferWithParams(
    struct PRESWriterHistoryDriver *me,
    int *failReason,
    struct REDABuffer *buffer,
