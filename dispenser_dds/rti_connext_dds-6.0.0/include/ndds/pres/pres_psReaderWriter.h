...
/*
 * @(#)pres_psReaderWriter.h    generated by: makeheader    Thu Feb 28 22:12:38 2019
 *
...
PRESPsReader_readInstance(
	...
	const struct PRESInstanceHandle *handle,
        const struct PRESOctetGuid *topicQueryGuid,
...
extern PRESDllExport
void PRESPsReader_getSecurityAttributes(
        struct PRESPsReader *reader,
...
extern PRESDllExport
void PRESPsWriter_getSecurityAttributes(
        struct PRESPsWriter *writer,
        struct PRESEndpointSecurityAttributes *attributes);

extern PRESDllExport
RTIBool PRESPsWriter_getLoan(
        struct PRESPsWriter *writer,
        int *failReason,
        void **sample,
        struct REDAWorker *worker);
...
extern PRESDllExport
RTIBool PRESPsWriter_discardLoan(
        struct PRESPsWriter *writer,
        int *failReason,
        void *sample,
        struct REDAWorker *worker);
