...
/*
 * @(#)pres_participant.h    generated by: makeheader    Thu Feb 28 22:12:35 2019
 *
...
/* This property can be used to enable backward compatibility with 4.5d and
 * earlier DATA_FRAG submessage alignment.
 */
#define PRES_PARTICIPANT_USE_45D_COMPATIBLE_ALIGNMENT_ENFORCEMENT_PROPERTY_NAME \
...
/* This property can be used to force the SHMEM locator matching as it was done
 * before CORE-8490. If set to true we will only check that the locators
 * contain the exactly same address. If set to false it will (by default) we
 * will try to attach to the SHMEM segment and verify the UUID as long as
 * the received address is valid for SHMEM (last four bytes set to 0)
 */
#define PRES_PARTICIPANT_USE_530_SHMEM_LOCATOR_MATCHING_PROPERTY_NAME \
    "dds.transport.use_530_shmem_locator_matching"
...
#define PRES_PARTICIPANT_TRUST_PLUGINS_IS_NON_SECURE_PARTICIPANT_DISCOVERY_MUTABLE_PROPERTY_NAME \
    "dds.participant.trust_plugins.is_non_secure_participant_discovery_mutable"
...
typedef RTICdrUnsignedLong PRESParticipantSecurityAttributesBitmask;

typedef RTICdrUnsignedLong PRESPluginParticipantSecurityAttributesBitmask;


#define PRES_PARTICIPANT_SECURITY_ATTRIBUTES_FLAG_IS_RTPS_PROTECTED       (0x00000001 << 0)
#define PRES_PARTICIPANT_SECURITY_ATTRIBUTES_FLAG_IS_DISCOVERY_PROTECTED  (0x00000001 << 1)
#define PRES_PARTICIPANT_SECURITY_ATTRIBUTES_FLAG_IS_LIVELINESS_PROTECTED (0x00000001 << 2)
#define PRES_PARTICIPANT_SECURITY_ATTRIBUTES_FLAG_IS_VALID                (0x00000001 << 31)

#define PRES_PARTICIPANT_SECURITY_ATTRIBUTES_BITMASK_DEFAULT 0
#define PRES_PLUGIN_PARTICIPANT_SECURITY_ATTRIBUTES_BITMASK_DEFAULT 0

#define PRESParticipantSecurityAttributesBitmask_isRtpsProtected(att) \
        (((att) & PRES_PARTICIPANT_SECURITY_ATTRIBUTES_FLAG_IS_RTPS_PROTECTED) != 0)

#define PRESParticipantSecurityAttributesBitmask_isDiscoveryProtected(att) \
        (((att) & PRES_PARTICIPANT_SECURITY_ATTRIBUTES_FLAG_IS_DISCOVERY_PROTECTED) != 0)

#define PRESParticipantSecurityAttributesBitmask_isLivelinessProtected(att) \
        (((att) & PRES_PARTICIPANT_SECURITY_ATTRIBUTES_FLAG_IS_LIVELINESS_PROTECTED) != 0)

#define PRESParticipantSecurityAttributesBitmask_isValid(att) \
        (((att) & PRES_PARTICIPANT_SECURITY_ATTRIBUTES_FLAG_IS_VALID) != 0)

#define PRESParticipantSecurityAttributesBitmask_compare(left, right) \
        (!PRESParticipantSecurityAttributesBitmask_isValid(left) \
                && !PRESParticipantSecurityAttributesBitmask_isValid(right) ? 0 : \
                        REDAOrderedDataType_compareInt(&(left), &(right)))

#define PRESParticipantSecurityInfo_compare(left, right) \
        (PRESParticipantSecurityAttributesBitmask_compare( \
                (left)->bitmask, \
                (right)->bitmask) != 0 \
                ? PRESParticipantSecurityAttributesBitmask_compare( \
                        (left)->bitmask, \
...
struct PRESParticipantSecurityInfo {
    PRESParticipantSecurityAttributesBitmask bitmask;
    PRESPluginParticipantSecurityAttributesBitmask pluginBitmask;
};


#define PRES_PARTICIPANT_SECURITY_INFO_DEFAULT \
{ \
    PRES_PARTICIPANT_SECURITY_ATTRIBUTES_BITMASK_DEFAULT, \
    PRES_PLUGIN_PARTICIPANT_SECURITY_ATTRIBUTES_BITMASK_DEFAULT \
}

struct PRESParticipantSecurityAttributes {
    RTIBool allowUnauthenticatedParticipants;
    RTIBool isAccessProtected;
    RTIBool isNonSecureParticipantDiscoveryMutable;
    struct PRESParticipantSecurityInfo info;
};
...
{ \
    ...
    RTI_FALSE, /* isNonSecureParticipantDiscoveryMutable */ \
    PRES_PARTICIPANT_SECURITY_INFO_DEFAULT /* info */ \
}
...
struct PRESParticipantParameter {
    ...
    /*e immutable */
    PRESBuiltinEndpointQos_t builtinEndpointQosMask;
    /*e immutable */
    int domainId;
    /*e immutable
     *
     * domainTag is currently stored as a property. This member keeps a pointer
     * to that property. Immutability is enforce both at local participant level
     * and at discovery level, as we will not assert remote participant updates
     * containing a domainTag that is  different to the one we expect.
     */
    MIGRtpsDomainTag domainTag;
    /*e immutable */
    ...
    /*e immutable */
    struct PRESParticipantSecurityInfo securityInfo;
    /*e immutable */
...
*/
  #define PRES_PARTICIPANT_PARAMETER_DEFAULT { \
        ...
        PRES_PARTICIPANT_PARAMETER_MANAGER_KEY_INVALID, \
        PRES_PARTICIPANT_PARAMETER_MANAGER_KEY_INVALID}, \
        PRES_PARTICIPANT_LEASE_DURATION_DEFAULT,  /* leaseDuration */ \
        ...
        PRES_BUILTIN_ENDPOINT_QOS_NONE, /*builtinEndpointQosMask*/ \
        MIG_RTPS_DOMAIN_DEFAULT, /* domainId */ \
        MIG_RTPS_DOMAIN_TAG_DEFAULT, /* domainTag */ \
        ...
        PRES_PARTICIPANT_SECURITY_INFO_DEFAULT, /* securityInfo */ \
        PRES_PARTICIPANT_SERVICE_QOS_POLICY_DEFAULT, /* serviceQosPolicy */ \
        PRES_LOCATOR_QOS_POLICY_DEFAULT, /* metatrafficUnicastLocator */ \
        PRES_REDUCED_LOCATOR_QOS_POLICY_DEFAULT, /* metatrafficMulticastLocator */ \
        PRES_LOCATOR_QOS_POLICY_DEFAULT, /* defaultUnicastLocator */ \
        PRES_REDUCED_LOCATOR_QOS_POLICY_DEFAULT, /* defaultMulticastLocator */ \
        {{0, 0, NULL}}, /* userData */ \
        0, /* peerHostEpoch*/ \
...
#define PRES_SHMEM_REF_TRANSFER_MODE_MAX_SEGMENTS (500)
...
struct PRESParticipantProperty {
    ...
    /* Determines if 5.3.0 shmem locator matching should be used. */
    RTIBool shmemUse530LocatorMatching;

    RTI_UINT32 shmemRefTransferModeMaxSegments;
...
*/
  #define PRES_PARTICIPANT_PROPERTY_DEFAULT { \
      ...
      RTI_FALSE, /* shmemUse530LocatorMatching */ \
      PRES_SHMEM_REF_TRANSFER_MODE_MAX_SEGMENTS, /* shmemRefTransferModeMaxSegments */ \
...
typedef RTIBool (*PRESParticipant_GetTopicAttributesFunction)(
        struct PRESParticipant *participant,
        /* output */
        struct PRESTopicSecurityAttributes *attributes,
        /* inputs */
...
typedef RTIBool (*PRESParticipant_ReturnEndpointAttributesFunction)(
        struct PRESParticipant *participant,
        /* inout */
        struct PRESEndpointSecurityAttributes *attributes,
        /* input */
...
(*PRESParticipant_RegisterLocalEndpointFunction)(
    ...
    struct PRESEndpointSecurityAttributes *endpointSecurityAttributes);
...
(*PRESParticipant_CheckRemoteDataWriterFunction)(
    ...
    RTIBool remoteTopicFromRemoteParticipantExists);
...
struct PRESParticipantSecurityForwarder {
    ...
    PRESParticipant_GetTopicAttributesFunction getTopicAttributes;
    PRESParticipant_GetEndpointAttributesFunction getEndpointAttributes;
    PRESParticipant_ReturnEndpointAttributesFunction returnEndpointAttributes;
...
extern PRESDllExport
RTIBool PRESParticipant_isSecureParticipantDiscoveryDisabled(
        struct PRESParticipant *me);
...
extern PRESDllExport
RTIBool PRESParticipant_getTopicSecAttributes(
        struct PRESParticipant *me,
        struct PRESTopicSecurityAttributes *attributes,
        const struct MIGRtpsGuid *guid,
        const char *topicName);
...
extern PRESDllExport
RTIBool PRESParticipant_returnEndpointSecAttributes(
        struct PRESParticipant *me,
        struct PRESEndpointSecurityAttributes *attributes,
        const struct MIGRtpsGuid *guid);


#define PRES_INSTANCE_HANDLE_INVALID_KEYHASH 0
...
/*
 * This is used by DataWriters and DataReaders for which is_key_protected is
 * set to true.
 */
#define PRES_INSTANCE_HANDLE_VALID_SECURE_KEYHASH 2
/*
 * This is the v2 keyhash generation. It is not safe because if the maximum
 * serialized size of the key is <= 16 the keyhash is the serialized key in big
 * endian order.
 */
#define PRES_INSTANCE_HANDLE_VALID_UNSECURE_KEYHASH_V2 3
/*
 * This is used by v2 DataWriters and DataReaders for which is_key_protected is
 * set to true.
 */
#define PRES_INSTANCE_HANDLE_VALID_SECURE_KEYHASH_V2 4
...
struct PRESInstanceHandle {
     ...
     * This field encodes three kinds of information:
     * 1) Whether or not the instance handle is valid or NIL.
     * 2) For valid instance handles, this field encodes the kind of keyhash
     *    generation. It can be secure or unsecure. With secure keyhash the
     *    keyhash is always an MD5 of the serialized key.
     * 3) If the is a v1 or v2 keyhash.
     */
    RTI_INT32 isValid;
};
 ...
 */
  #define PRES_INSTANCE_HANDLE_NIL { \
      ...
      PRES_INSTANCE_HANDLE_INVALID_KEYHASH /* isValid */ }

/*e \ingroup PRESInstanceHandleClass
 * Invalid instance handle. This is also explicitly sets keyhash to invalid.
 */
  #define PRES_INSTANCE_HANDLE_INVALID { \
      MIG_RTPS_KEY_HASH_DEFAULT, \
      PRES_INSTANCE_HANDLE_INVALID_KEYHASH /* isValid */ }
...
extern PRESDllExport
void PRESInstanceHandle_copy(
        struct PRESInstanceHandle *dst,
        const struct PRESInstanceHandle *src);

extern PRESDllExport 
RTIBool PRESInstanceHandle_isNil(const struct PRESInstanceHandle *me);

extern PRESDllExport
RTIBool PRESInstanceHandle_isProtected(const struct PRESInstanceHandle *me);

extern PRESDllExport
RTIBool PRESInstanceHandle_isV2(const struct PRESInstanceHandle *me);

extern PRESDllExport
RTI_INT32 PRESInstanceHandle_getInstanceHandleIsValidValue(
        RTIBool useV2Encapsulation,
        RTIBool useKeyProtection);

extern PRESDllExport
RTIBool PRESInstanceHandle_isInstanceHandleCompatible( \
        const struct PRESInstanceHandle *me,
        RTIBool useV2Encapsulation,
        RTIBool useKeyProtection);

extern PRESDllExport
void PRESInstanceHandle_fromGuid(
        struct PRESInstanceHandle *me,
        const struct MIGRtpsGuid *guid);
...
struct PRESSampleInfo {
    ...
    */
    ...
    /* Used by metp module, initialized as RTI_CDR_ENCAPSULATION_ID_INVALID */
...
extern	PRESDllExport
struct REDAFastBufferPool *PRESParticipant_createSequencePropertyBufferPool(
        int maxPropertyLength,
        int maxPropertyStringLength,
        const struct REDAFastBufferPoolProperty *poolP);


extern	PRESDllExport
void PRESParticipant_returnPropertyQosBuffer(
...
struct PRESParticipantGenericMessageMetaData {
    ...
    struct MIGRtpsGuid destinationParticipantKey;
...
#define PRES_PARTICIPANT_GENERIC_MESSAGE_META_DATA_DEFAULT { \
        ...
        MIG_RTPS_GUID_UNKNOWN /* destinationParticipantKey */, \
