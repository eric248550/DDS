...
/*
 * @(#)pres_common.h    generated by: makeheader    Thu Feb 28 22:12:35 2019
 *
...
#define pres_common_h
    ...
    #include "reda/reda_boundedSeq.h"
 #endif
...
#define PRES_PARTICIPANT_DOMAIN_TAG_PROPERTY_NAME ("dds.domain_participant.domain_tag")
...
#define PRES_PARTICIPANT_DISCOVERY_DISABLE_SECURE_PARTICIPANT_DISCOVERY_PROPERTY_NAME "dds.participant.discovery_config.disable_secure_participant_discovery"
...
#define PRES_PARTICIPANT_DISCOVERY_DISABLE_ENDPOINT_SECURITY_INFO_PROPAGATION_NAME "dds.participant.discovery_config.disable_endpoint_security_info_propagation"
#define PRES_PARTICIPANT_DISCOVERY_DISABLE_PARTICIPANT_SECURITY_INFO_PROPAGATION_NAME "dds.participant.discovery_config.disable_participant_security_info_propagation"
#define PRES_PARTICIPANT_DISCOVERY_DISABLE_PARTICIPANT_SECURITY_INFO_VALIDATION_NAME "dds.participant.discovery_config.disable_participant_security_info_validation"
#define PRES_PARTICIPANT_DISCOVERY_ENABLE_FRAGMENTATION_PROPERTY "dds.participant.discovery_config.enable_fragmentation"



#define PRES_PARTICIPANT_DISCOVERY_ENDPOINT_TYPE_OBJECT_LB_SERIALIZATION_THRESHOLD_PROPERTY_NAME \
    "dds.participant.discovery_config.endpoint_type_object_lb_serialization_threshold"
#define PRES_PARTICIPANT_DISCOVERY_ENDPOINT_TYPE_OBJECT_LB_SERIALIZATION_ALGORITHM_PROPERTY_NAME \
    "dds.participant.discovery_config.endpoint_type_object_lb_serialization_algorithm"
...
typedef RTI_INT32 PRESDataRepresentationCdrSupportMask;

typedef enum {
    PRES_DATA_REPRESENTATION_CDR_SUPPORT_FLAG_CDR_V1 = 0x0001 << 0,
    PRES_DATA_REPRESENTATION_CDR_SUPPORT_FLAG_CDR_V2 = 0x0001 << 1
} PRESDataRepresentationCdrSupportFlagBits;


#define PRES_DATA_REPRESENTATION_CDR_SUPPORT_MASK_INVALID (0)


/*e
  This value is set to 4 because the XTypes 1.2 specification allows
  3 representations (namely XCDR, XCDR2 and XML) and the specification also
  allows the user to add their own custom representation.
*/
#define PRES_MAX_DATA_REPRESENTATION_VALUES 4


typedef RTI_INT16 PRESDataRepresentation;

REDA_BOUNDED_SEQUENCE(
        PRESDataRepresentationBoundedSeq,
        PRESDataRepresentation,
        PRES_MAX_DATA_REPRESENTATION_VALUES)


/*e
Predefined data representations. Used by disc for initialization.
*/
#define PRES_XCDR_DATA_REPRESENTATION 0
#define PRES_XML_DATA_REPRESENTATION 1
#define PRES_XCDR2_DATA_REPRESENTATION 2

struct PRESDataRepresentationQosPolicy {
    /*e
     * Bounded seq of PRESDataRepresentation for storing data representations
     */
    PRESDataRepresentationBoundedSeq value;
};


#define PRES_DATA_REPRESENTATION_QOS_POLICY_DEFAULT {   \
    {                                                   \
        PRES_MAX_DATA_REPRESENTATION_VALUES,            \
        0,                                              \
        {0} /* _buffer */                               \
...
int PRESDataRepresentationQosPolicy_compare(
        const struct PRESDataRepresentationQosPolicy *left,
        const struct PRESDataRepresentationQosPolicy *right);
...
#define PRES_DDS_SEQUENCE_INVALID { \
    RTI_TRUE, \
    NULL, \
    NULL, \
    0L, \
    0L, \
    0, /* non valid magic number */ \
    NULL, \
    NULL, \
    PRESTypeAllocationParams_INITIALIZER, \
    PRESTypeDeallocationParams_INITIALIZER, \
...
#define PRES_SEQUENCE_PROPERTY_DEFAULT {0,0,NULL,0,0,NULL}
#define PRES_PROPERTY_QOS_POLICY_DEFAULT {PRES_SEQUENCE_PROPERTY_DEFAULT}

extern PRESDllExport
const char *PRESSequenceProperty_getValue(
        const struct PRESSequenceProperty *self,
        const char *name);


extern	PRESDllExport
int PRESPropertyQosPolicy_compare(
        const struct PRESPropertyQosPolicy *left,
        const struct PRESPropertyQosPolicy *right);


extern	PRESDllExport
RTIBool PRESPropertyQosPolicy_copy(
        struct PRESPropertyQosPolicy *out,
        const struct PRESPropertyQosPolicy *in);


extern	RTIBool PRESSequenceProperty_getBoolean(
        const struct PRESSequenceProperty *self,
        RTIBool *value,
        const char *name);
...
extern	PRESDllExport
RTIBool PRESPropertyQosPolicy_addIntegerProperty(
        struct PRESPropertyQosPolicy *propertyQos,
        const char *name,
        int value);

extern PRESDllExport
RTIBool PRESPropertyQosPolicy_addStringProperty(
        struct PRESPropertyQosPolicy *propertyQos,
        const char *name,
        const char *value);

extern PRESDllExport
MIGRtpsDomainTag PRESPropertyQosPolicy_getDomainTag(
        const struct PRESPropertyQosPolicy *propertyQos,
        const MIGRtpsDomainTag expectedDomainTag);

typedef struct PRESPropertyQosPolicy PRESDataTagQosPolicy;


#define PRES_DATA_TAG_QOS_POLICY_DEFAULT PRES_PROPERTY_QOS_POLICY_DEFAULT


extern	PRESDllExport
RTIBool PRESDataTagQosPolicy_copy(
        PRESDataTagQosPolicy *out,
        const PRESDataTagQosPolicy *in);
...
typedef enum {
    ...
    */
    ...
    /*e
     * Sample is rejected because the instance is unknown.
     */
    PRES_REJECTED_BY_UNKNOWN_INSTANCE
...
typedef enum {
    ...
    */
    ...
    /*e
     * Sample is lost because the instance is unknown.
     */
    PRES_LOST_BY_UNKNOWN_INSTANCE
...
typedef enum {
    ...
    /*e PRESDataRepresentationQosPolicy */
    PRES_DATA_REPRESENTATION_QOS_POLICY
} PRESQosPolicyId;
...
/*e \ingroup PRESStatusModule 
  Policy index for data representation qos
*/
  #define PRES_INCOMPATIBLE_DATA_REPRESENTATION_QOS_POLICY_INDEX (8)
/*e \ingroup PRESStatusModule 
  The maximum number of QoS that can be incompatible between reader and
  writer pair.
*/
  #define PRES_INCOMPATIBLE_QOS_POLICY_MAX (9)
...
typedef RTICdrUnsignedLong PRESPluginEndpointSecurityAttributesBitmask;



#define PRES_ENDPOINT_SECURITY_ATTRIBUTES_FLAG_IS_READ_PROTECTED       (0x00000001 << 0)
#define PRES_ENDPOINT_SECURITY_ATTRIBUTES_FLAG_IS_WRITE_PROTECTED      (0x00000001 << 1)
#define PRES_ENDPOINT_SECURITY_ATTRIBUTES_FLAG_IS_DISCOVERY_PROTECTED  (0x00000001 << 2)
#define PRES_ENDPOINT_SECURITY_ATTRIBUTES_FLAG_IS_SUBMESSAGE_PROTECTED (0x00000001 << 3)
#define PRES_ENDPOINT_SECURITY_ATTRIBUTES_FLAG_IS_PAYLOAD_PROTECTED    (0x00000001 << 4)
#define PRES_ENDPOINT_SECURITY_ATTRIBUTES_FLAG_IS_KEY_PROTECTED        (0x00000001 << 5)
#define PRES_ENDPOINT_SECURITY_ATTRIBUTES_FLAG_IS_LIVELINESS_PROTECTED (0x00000001 << 6)
#define PRES_ENDPOINT_SECURITY_ATTRIBUTES_FLAG_IS_VALID                (0x00000001 << 31)

#define PRES_ENDPOINT_SECURITY_ATTRIBUTES_BITMASK_DEFAULT 0
#define PRES_PLUGIN_ENDPOINT_SECURITY_ATTRIBUTES_BITMASK_DEFAULT 0

#define PRES_ENDPOINT_SECURITY_ATTRIBUTES_BITMASK_IS_ENCODING \
    (PRES_ENDPOINT_SECURITY_ATTRIBUTES_FLAG_IS_SUBMESSAGE_PROTECTED \
     | PRES_ENDPOINT_SECURITY_ATTRIBUTES_FLAG_IS_PAYLOAD_PROTECTED)


#define PRESEndpointSecurityAttributesBitmask_isReadProtected(att) \
        (((att) & PRES_ENDPOINT_SECURITY_ATTRIBUTES_FLAG_IS_READ_PROTECTED) != 0)

#define PRESEndpointSecurityAttributesBitmask_isWriteProtected(att) \
        (((att) & PRES_ENDPOINT_SECURITY_ATTRIBUTES_FLAG_IS_WRITE_PROTECTED) != 0)

#define PRESEndpointSecurityAttributesBitmask_isAccessProtected(att, endpointType) \
        (((endpointType) == MIG_RTPS_RW_TYPE_READER) \
                ? (PRESEndpointSecurityAttributesBitmask_isReadProtected(att)) \
                : (((endpointType) == MIG_RTPS_RW_TYPE_WRITER) \
                        ? (PRESEndpointSecurityAttributesBitmask_isWriteProtected(att)) \
                        : RTI_FALSE) \
        )

#define PRESEndpointSecurityAttributesBitmask_isDiscoveryProtected(att) \
        (((att) & PRES_ENDPOINT_SECURITY_ATTRIBUTES_FLAG_IS_DISCOVERY_PROTECTED) != 0)

#define PRESEndpointSecurityAttributesBitmask_isSubmessageProtected(att) \
        (((att) & PRES_ENDPOINT_SECURITY_ATTRIBUTES_FLAG_IS_SUBMESSAGE_PROTECTED) != 0)

#define PRESEndpointSecurityAttributesBitmask_isPayloadProtected(att) \
        (((att) & PRES_ENDPOINT_SECURITY_ATTRIBUTES_FLAG_IS_PAYLOAD_PROTECTED) != 0)

#define PRESEndpointSecurityAttributesBitmask_isKeyProtected(att) \
        (((att) & PRES_ENDPOINT_SECURITY_ATTRIBUTES_FLAG_IS_KEY_PROTECTED) != 0)

#define PRESEndpointSecurityAttributesBitmask_isLivelinessProtected(att) \
        ((att & PRES_ENDPOINT_SECURITY_ATTRIBUTES_FLAG_IS_LIVELINESS_PROTECTED) != 0)

#define PRESEndpointSecurityAttributesBitmask_isValid(att) \
        (((att) & PRES_ENDPOINT_SECURITY_ATTRIBUTES_FLAG_IS_VALID) != 0)

#define PRESEndpointSecurityAttributesBitmask_isEncoding(att) \
        (((att) & PRES_ENDPOINT_SECURITY_ATTRIBUTES_BITMASK_IS_ENCODING) != 0)

#define PRESEndpointSecurityAttributesBitmask_compare(left, right) \
        (!PRESEndpointSecurityAttributesBitmask_isValid(left) \
                && !PRESEndpointSecurityAttributesBitmask_isValid(right) ? 0 : \
                        REDAOrderedDataType_compareInt(&(left), &(right)))

#define PRESEndpointSecurityInfo_isDefault(info) \
        ((info)->bitmask == PRES_ENDPOINT_SECURITY_ATTRIBUTES_BITMASK_DEFAULT \
                && (info)->pluginBitmask == PRES_PLUGIN_ENDPOINT_SECURITY_ATTRIBUTES_BITMASK_DEFAULT)

#define PRESEndpointSecurityInfo_compare(left, right) \
        (PRESEndpointSecurityAttributesBitmask_compare( \
                (left)->bitmask, \
                (right)->bitmask) != 0 \
                ? PRESEndpointSecurityAttributesBitmask_compare( \
                        (left)->bitmask, \
...
#define PRES_ENDPOINT_RTI_SECURITY_ATTRIBUTES_FLAG_IS_ACCESS_PROTECTED      (0x00000001 << 0)
#define PRES_ENDPOINT_RTI_SECURITY_ATTRIBUTES_FLAG_IS_DISCOVERY_PROTECTED   (0x00000001 << 1)
#define PRES_ENDPOINT_RTI_SECURITY_ATTRIBUTES_FLAG_IS_SUBMESSAGE_PROTECTED  (0x00000001 << 2)
#define PRES_ENDPOINT_RTI_SECURITY_ATTRIBUTES_IS_PAYLOAD_SIGNED             (0x00000001 << 3)
#define PRES_ENDPOINT_RTI_SECURITY_ATTRIBUTES_IS_PAYLOAD_ENCRYPTED          (0x00000001 << 4)
#define PRES_ENDPOINT_RTI_SECURITY_ATTRIBUTES_IS_LIVELINESS_PROTECTED       (0x00000001 << 5)
#define PRES_ENDPOINT_RTI_SECURITY_ATTRIBUTES_IS_SECURITY_INFO_DISABLED     (0x00000001 << 29)
#define PRES_ENDPOINT_RTI_SECURITY_ATTRIBUTES_IS_NON_PROPAGABLE             (0x00000001 << 30)
#define PRES_ENDPOINT_RTI_SECURITY_ATTRIBUTES_IS_INVALID                    (0x00000001 << 31)

#define PRES_ENDPOINT_RTI_SECURITY_ATTRIBUTES_BITMASK_NONE 0
#define PRES_ENDPOINT_RTI_SECURITY_ATTRIBUTES_BITMASK_DEFAULT \
        PRES_ENDPOINT_RTI_SECURITY_ATTRIBUTES_IS_INVALID

#define PRES_ENDPOINT_RTI_SECURITY_ATTRIBUTES_BITMASK_IS_ENCODING \
    (PRES_ENDPOINT_RTI_SECURITY_ATTRIBUTES_FLAG_IS_SUBMESSAGE_PROTECTED \
     | PRES_ENDPOINT_RTI_SECURITY_ATTRIBUTES_IS_PAYLOAD_SIGNED \
     | PRES_ENDPOINT_RTI_SECURITY_ATTRIBUTES_IS_PAYLOAD_ENCRYPTED)

#define PRESEndpointRtiSecurityAttributesBitmask_isEndpointSecurityInfoPropagationDisabled(att) \
        (((att) & PRES_ENDPOINT_RTI_SECURITY_ATTRIBUTES_IS_SECURITY_INFO_DISABLED) != 0)

#define PRESEndpointRtiSecurityAttributesBitmask_isPropagable(att) \
        (((att) & PRES_ENDPOINT_RTI_SECURITY_ATTRIBUTES_IS_NON_PROPAGABLE) == 0)

#define PRESEndpointRtiSecurityAttributesBitmask_isValid(att) \
        (((att) & PRES_ENDPOINT_RTI_SECURITY_ATTRIBUTES_IS_INVALID) == 0)

extern PRESDllExport
PRESEndpointRtiSecurityAttributesBitmask
PRESEndpointSecurityAttributesBitmask_toRtiSecurityAttributesBitmask(
        PRESEndpointSecurityAttributesBitmask att,
        MIGRtpsRWType endpointType);

extern PRESDllExport
PRESEndpointSecurityAttributesBitmask
PRESEndpointSecurityAttributesBitmask_fromRtiSecurityAttributesBitmask(
        PRESEndpointRtiSecurityAttributesBitmask rtiAtt);

struct PRESEndpointSecurityInfo {
    PRESEndpointSecurityAttributesBitmask bitmask;
    PRESPluginEndpointSecurityAttributesBitmask pluginBitmask;
};


#define PRES_ENDPOINT_SECURITY_INFO_DEFAULT \
{ \
    PRES_ENDPOINT_SECURITY_ATTRIBUTES_BITMASK_DEFAULT, \
    PRES_PLUGIN_ENDPOINT_SECURITY_ATTRIBUTES_BITMASK_DEFAULT \
}

struct PRESEndpointSecurityAttributes {
    struct PRESEndpointSecurityInfo info;
    struct PRESDDSSequence *acEndpointProperties;
};


#define PRES_ENDPOINT_SECURITY_ATTRIBUTES_DEFAULT \
{ \
    PRES_ENDPOINT_SECURITY_INFO_DEFAULT, \
    NULL /* acEndpointProperties */ \
}

struct PRESEndpointSecurity {
    struct PRESEndpointSecurityAttributes attributes;
...
struct PRESTopicSecurityAttributes {
    RTICdrBoolean isReadProtected;
    RTICdrBoolean isWriteProtected;
    RTICdrBoolean isDiscoveryProtected;
    RTICdrBoolean isLivelinessProtected;
};


#define PRES_TOPIC_SECURITY_ATTRIBUTES_DEFAULT \
{ \
    RTI_CDR_BOOLEAN_FALSE, /* isReadProtected */ \
    RTI_CDR_BOOLEAN_FALSE, /* isWriteProtected */ \
    RTI_CDR_BOOLEAN_FALSE, /* isDiscoveryProtected */ \
    RTI_CDR_BOOLEAN_FALSE  /* isLivelinessProtected */ \
}
...
struct PRESLocalEndpoint {
    ...
    */
     ...
     */
     ...
     /* Cdr data representation(s) supported by this endpoint. */
     PRESDataRepresentationCdrSupportMask _cdrSupportMask;
...
struct PRESTypeConsistencyEnforcementQosPolicy {
    ...
    RTICdrBoolean ignoreSequenceBounds;
    RTICdrBoolean ignoreStringBounds;
    RTICdrBoolean ignoreMemberNames;
    RTICdrBoolean preventTypeWidening;
    RTICdrBoolean forceTypeValidation;
    RTICdrBoolean ignoreEnumLiteralNames;
};


#define PRES_TYPE_CONSISTENCY_ENFORCEMENT_QOS_DEFAULT { \
    PRES_ALLOW_TYPE_COERCION, \
    RTI_CDR_BOOLEAN_FALSE, /* ignoreSequenceBounds (OMG-191) */ \
    RTI_CDR_BOOLEAN_FALSE, /* ignoreStringBounds (OMG-191) */ \
    RTI_CDR_BOOLEAN_FALSE, /* ignoreMemberNames */ \
    RTI_CDR_BOOLEAN_FALSE, /* preventTypeWidening */ \
    RTI_CDR_BOOLEAN_FALSE, /* forceTypeValidation */ \
    RTI_CDR_BOOLEAN_FALSE  /* ignoreEnumLiteralNames */ \
}
...
struct PRESTopicImmutableProperty {
     ...
     */
     struct PRESDataRepresentationQosPolicy dataRepresentationQosPolicy;
};
...
#define PRES_TOPIC_PROPERTY_DEFAULT {                               \
  { /* immutable_part */ \
   ...
   PRES_DATA_REPRESENTATION_QOS_POLICY_DEFAULT /* dataRepresentationQosPolicy */ \
  } /* end immutable */,                                            \
  { /* mutable_part */ \
...
PRESLocatorFilterQosProperty_copy(
        ...
        const struct PRESDataRepresentationQosPolicy *dataRepQos);
...
*/
#define PRES_PRODUCT_VERSION_MAJOR_DEFAULT 0
#define PRES_PRODUCT_VERSION_MINOR_DEFAULT 0
#define PRES_PRODUCT_VERSION_RELEASE_DEFAULT '0'
#define PRES_PRODUCT_VERSION_REVISION_DEFAULT 0

#define PRES_PRODUCT_VERSION_DEFAULT { \
    PRES_PRODUCT_VERSION_MAJOR_DEFAULT, \
    PRES_PRODUCT_VERSION_MINOR_DEFAULT, \
    PRES_PRODUCT_VERSION_RELEASE_DEFAULT, \
    PRES_PRODUCT_VERSION_REVISION_DEFAULT}
...
typedef RTICdrUnsignedLong PRESBuiltinEndpointQos_t;


#define PRES_BUILTIN_ENDPOINT_QOS_NONE  (0)

typedef enum PRESBuiltinEndpointQosBits {
    PRES_BUILTIN_ENDPOINT_QOS_BIT_BEST_EFFORT_PARTICIPANT_MESSAGE_DATA_READER = (1 << 0),
    /* RTI extension (only used internally, never sent to the wire). */
    PRES_BUILTIN_ENDPOINT_QOS_BIT_IS_VALID = (1 << 31)
} PRESBuiltinEndpointQosBits;


#define PRESBuiltinEndpointQos_isValid(qos) \
        (((qos) & PRES_BUILTIN_ENDPOINT_QOS_BIT_IS_VALID) != 0)
...
struct PRESWriteParams {
    ...
    struct REDASequenceNumber relatedEpoch;
};
...
#define PRESSequenceEndpointGroup_INITIALIZER { \
        0, /* maximum */ \
        0, /* length */ \
        NULL, /* buffer */ \
        0, /* _string_maximum */ \
...
#define PRES_GMCLASSID_TRUST_AUTH_REQUEST "dds.sec.auth_request"
...
/*e \ingroup PRESInterParticipantModule
 *  Channel Service-ID for GMCLASSID_TRUST_AUTH_REQUEST messages.
 */
#define PRES_GMCLASSID_SERVICE_ID_TRUST_AUTH_REQUEST 6
...
typedef enum {
    PRES_TOPIC_QUERY_SELECTION_KIND_HISTORY_SNAPSHOT = 0,
    PRES_TOPIC_QUERY_SELECTION_KIND_CONTINUOUS
} PRESTopicQuerySelectionKind;
...
struct PRESTopicQuerySelection {
    ...
    PRESTopicQuerySelectionKind kind;
};


#define PRES_TOPIC_QUERY_SELECTION_DEFAULT \
{ \
    NULL, /* filterClassName */\
    NULL, /* filterExpression */\
    {0, 0, NULL}, /* filterParameters */\
    0 /* kind */\
}
 ...
 */
#define PRES_PARTICIPANT_LEASE_DURATION_SEC_DEFAULT   (100)
#define PRES_PARTICIPANT_LEASE_DURATION_NANOSEC_DEFAULT   (0)
#define PRES_PARTICIPANT_LEASE_DURATION_DEFAULT \
    {\
    PRES_PARTICIPANT_LEASE_DURATION_SEC_DEFAULT, \
    PRES_PARTICIPANT_LEASE_DURATION_NANOSEC_DEFAULT \
    }
#define PRES_PARTICIPANT_REACHABILITY_LEASE_DURATION_DEFAULT  RTI_NTP_TIME_MAX



/*e \ingroup PRESInterParticipantModule
 *  Name of topic used for sending participant liveliness updates.
 */
#define PRES_PARTICIPANT_MESSAGE_TOPIC  "PRESInterParticipantTopic"

/*e \ingroup PRESInterParticipantModule
 *  Name of topic used for sending secure participant liveliness updates.
 */
#define PRES_PARTICIPANT_MESSAGE_SECURE_TOPIC "PRESInterParticipantTopicSecure"
