...
/*
 * @(#)pres_cstReaderCollator.h    generated by: makeheader    Thu Feb 28 22:12:37 2019
 *
...
struct PRESCstReaderCollatorProperty {
    ...
    /* Reader data representations: used in operations with keyhashes. */
    PRESDataRepresentationCdrSupportMask cdrSupportMask;
...
#define PRES_CST_READER_COLLATOR_PROPERTY_DEFAULT {      \
    ...
    PRES_DATA_REPRESENTATION_CDR_SUPPORT_MASK_INVALID, /* cdrSupportMask */ \
...
PRESCstReaderCollator_getRemoteWriterQueue(
        ...
        const struct PRESDataRepresentationQosPolicy *dataRepresentationQos,
...
PRESCstReaderCollator_new(
    ...
    struct REDAFastBufferPool *fstSampleDataPool,
