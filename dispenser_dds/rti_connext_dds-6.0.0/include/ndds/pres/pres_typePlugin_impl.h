...
/*
 * @(#)pres_typePlugin_impl.h    generated by: makeheader    Thu Feb 28 22:12:33 2019
 *
...
struct PRESTypePluginDefaultParticipantData {
    ...
    void *_metpPluginData; /* used by metp plugin */
    PRESTypePluginSampleAssignabilityProperty _assignabilityProperty;
...
struct PRESTypePluginDefaultEndpointData {
    ...
    void * _sample;
    unsigned int _maxSizeSerializedKeyV1;
    unsigned int _maxSizeSerializedKeyV2;
    ...
    PRESTypePluginSampleAssignabilityProperty _assignabilityProperty;
    void* userData;          /* used by dynamic data */
    void *_dotnetPluginData;  /* used by dotnet api */
    void *_metpPluginData;  /* used by metp */
    void *_plainHelperSample; /* Used by FlatData */
    ...
    struct RTIXCdrTypePluginProgramContext programContext;

    /* Pointer to sampleDataPool loaned to
     * COMMENDFragmentedSampleTableResourcePool */
    struct REDAFastBufferPool *_fstSampleDataPool;
};
...
#define PRESTypePluginDefaultEndpointData_getMaxSizeSerializedKey(epd,v2) \
    ((v2)?((struct PRESTypePluginDefaultEndpointData *)epd)->_maxSizeSerializedKeyV2: \
        ((struct PRESTypePluginDefaultEndpointData *)epd)->_maxSizeSerializedKeyV1)
...
#define PRESTypePluginDefaultEndpointData_getPrograms(epd) \
    (((struct PRESTypePluginDefaultEndpointData *) epd)->_participantData->programs)

#define PRESTypePluginDefaultEndpointData_setPrograms(epd, programs) \
    (((struct PRESTypePluginDefaultEndpointData *) epd)->_participantData->programs = \
        (programs)

#define PRESTypePluginDefaultEndpointData_isSecurityEnabled(epd) \
    (((struct PRESTypePluginDefaultEndpointData *) epd)->_participantData->_getEncodedSerializedSampleSize != \
        NULL)

#define PRESTypePluginDefaultEndpointData_getFstSampleDataPool(epd) \
    ((struct PRESTypePluginDefaultEndpointData *)epd)->_fstSampleDataPool

#define PRESTypePluginDefaultEndpointData_setFstSampleDataPool(epd, fstSampleDataPool) \
    ((struct PRESTypePluginDefaultEndpointData *)epd)->_fstSampleDataPool = \
        fstSampleDataPool

#define PRESTypePluginDefaultEndpointData_getFstSampleWithSize(epd, size) \
    REDAFastBufferPool_getBufferWithSize( \
        ((struct PRESTypePluginDefaultEndpointData *)epd)->_fstSampleDataPool, \
        size)

#define PRESTypePluginDefaultEndpointData_supportsWriterLoanedSamplePool(epd) \
    (((struct PRESTypePluginDefaultEndpointData *)epd)->_pool->writerLoanedSamplePool != NULL)

#define PRESTypePluginDefaultEndpointData_setPlainHelperSample(epd, sample) \
    ((struct PRESTypePluginDefaultEndpointData *)epd)->_plainHelperSample \
        = (void *)sample

#define PRESTypePluginDefaultEndpointData_getPlainHelperSample(epd) \
    ((struct PRESTypePluginDefaultEndpointData *)epd)->_plainHelperSample
