...
/*
 * @(#)pres_psService.h    generated by: makeheader    Thu Feb 28 22:12:38 2019
 *
...
#define PRES_PS_ENDPOINT_DISCOVERY_TYPE_OBJECT_LB_SERIALIZATION_THRESHOLD_UNLIMITED (-1)
#define PRES_PS_ENDPOINT_DISCOVERY_TYPE_OBJECT_LB_SERIALIZATION_THRESHOLD_DEFAULT (0)
...
struct PRESPsSubscriptionParameter {
    ...
    /*e immutable. See struct PRESDataTagQosPolicy */
    PRESDataTagQosPolicy dataTagQosPolicy;
    /*e immutable. See struct PRESDataRepresentationQosPolicy */
    ...
    /* immutable */
    struct PRESEndpointSecurityInfo securityInfo;
    /* immutable */
    PRESEndpointRtiSecurityAttributesBitmask rtiSecurityAttributes;
...
#define PRES_PS_SUBSCRIPTION_PARAMETER_RELIABILITY_QOS_POLICY_DEFAULT { \
    ...
    {0, 429496729}, /* 100ms maxBlockingTime */ \
...
#define PRES_PS_SUBSCRIPTION_PARAMETER_DATA_TAG_QOS_POLICY_DEFAULT \
    PRES_DATA_TAG_QOS_POLICY_DEFAULT
#define PRES_PS_SUBSCRIPTION_PARAMETER_DATA_REPRESENTATION_QOS_POLICY_DEFAULT \
    PRES_DATA_REPRESENTATION_QOS_POLICY_DEFAULT
...
#define PRES_PS_SUBSCRIPTION_PARAMETER_CHANGE_EPOCH_UNKNOWN ((RTI_INT64) 0)
  ...
  #define PRES_PS_SUBSCRIPTION_PARAMETER_DEFAULT {                        \
    ...
    PRES_PS_SUBSCRIPTION_PARAMETER_DATA_TAG_QOS_POLICY_DEFAULT,           \
    PRES_PS_SUBSCRIPTION_PARAMETER_DATA_REPRESENTATION_QOS_POLICY_DEFAULT,\
    ...
    PRES_ENDPOINT_SECURITY_INFO_DEFAULT, /* securityInfo */               \
    PRES_ENDPOINT_RTI_SECURITY_ATTRIBUTES_BITMASK_DEFAULT, /* rtiSecurityAttributes */ \
...
/*e \ingroup PRESPsServiceModule */
#define PRES_PS_PUBLICATION_PARAMETER_STRENGTH_DEFAULT (0)
/*e \ingroup PRESPsServiceModule */
...
#define PRES_PS_PUBLICATION_PARAMETER_PROPERTY_QOS_POLICY_DEFAULT \
    PRES_PROPERTY_QOS_POLICY_DEFAULT
#define PRES_PS_PUBLICATION_PARAMETER_DATA_TAG_QOS_POLICY_DEFAULT \
    PRES_DATA_TAG_QOS_POLICY_DEFAULT
#define PRES_PS_PUBLICATION_PARAMETER_DATA_REPRESENTATION_QOS_POLICY_DEFAULT \
    PRES_DATA_REPRESENTATION_QOS_POLICY_DEFAULT
...
#define PRES_PS_PUBLICATION_PARAMETER_TYPE_OBJECT_MD5_DEFAULT \
  ...
  #define PRES_PS_PUBLICATION_PARAMETER_DEFAULT {                        \
    ...
    NULL, /* typeCode */                                                 \
    NULL, /* typeObject */                                               \
    PRES_PS_PUBLICATION_PARAMETER_TYPE_OBJECT_MD5_DEFAULT, /* typeObjectMd5 */  \
    PRES_PS_PUBLICATION_PARAMETER_RELIABILITY_QOS_POLICY_DEFAULT, /* reliabilityQosPolicy */       \
    PRES_PS_PUBLICATION_PARAMETER_EXPECTS_ACK_DEFAULT, /* expectsAck */  \
    PRES_PS_PUBLICATION_PARAMETER_SEND_QUEUE_SIZE_DEFAULT, /* sendQueueSize */             \
    PRES_PS_PUBLICATION_PARAMETER_MAX_SAMPLE_SERIALIZED_SIZE_DEFAULT, /* maxSampleSerializedSize */   \
    PRES_PS_PUBLICATION_PARAMETER_STRENGTH_DEFAULT,  /* strength */      \
    PRES_PS_PUBLICATION_PARAMETER_PERSISTENCE_DEFAULT, /* persistence */ \
    PRES_PS_PUBLICATION_PARAMETER_LIVELINESS_QOS_POLICY_DEFAULT, /* livelinessQosPolicy */         \
    PRES_PS_PUBLICATION_PARAMETER_DURABILITY_QOS_POLICY_DEFAULT, /* durabilityQosPolicy */        \
    PRES_PS_PUBLICATION_PARAMETER_DURABILITY_SERVICE_QOS_POLICY_DEFAULT, /* durabilityServiceQosPolicy */ \
    PRES_PS_PUBLICATION_PARAMETER_OWNERSHIP_QOS_POLICY_DEFAULT, /* ownershipQosPolicy */        \
    PRES_PS_PUBLICATION_PARAMETER_PRESENTATION_QOS_POLICY_DEFAULT, /* presentationQosPolicy */      \
    PRES_PS_PUBLICATION_PARAMETER_DESTINATION_ORDER_QOS_POLICY_DEFAULT, /* destinationOrderQosPolicy */  \
    PRES_PS_PUBLICATION_PARAMETER_DEADLINE_QOS_POLICY_DEFAULT, /* deadlineQosPolicy */          \
    PRES_PS_PUBLICATION_PARAMETER_LATENCY_BUDGET_QOS_POLICY_DEFAULT, /* latencyBudgetQosPolicy */     \
    PRES_PS_PUBLICATION_PARAMETER_LIFESPAN_QOS_POLICY_DEFAULT, /* lifespanQosPolicy */           \
    PRES_PS_PUBLICATION_PARAMETER_USER_DATA_QOS_POLICY_DEFAULT, /* userDataQosPolicy */          \
    PRES_PS_PUBLICATION_PARAMETER_GROUP_DATA_QOS_POLICY_DEFAULT, /* groupDataQosPolicy */        \
    PRES_PS_PUBLICATION_PARAMETER_TOPIC_DATA_QOS_POLICY_DEFAULT, /* topicDataQosPolicy  */        \
    PRES_PS_PUBLICATION_PARAMETER_PARTITION_QOS_POLICY_DEFAULT,  /* partitionQosPolicy */ \
    PRES_PS_PUBLICATION_PARAMETER_LOCATOR_FILTER_QOS_PROPERTY_DEFAULT, /* locatorFilterQosProperty */   \
    PRES_PS_PUBLICATION_PARAMETER_PROPERTY_QOS_POLICY_DEFAULT, /* propertyQosPolicy */          \
    PRES_PS_PUBLICATION_PARAMETER_DATA_TAG_QOS_POLICY_DEFAULT,  /* dataTagQosPolicy */          \
    PRES_PS_PUBLICATION_PARAMETER_DATA_REPRESENTATION_QOS_POLICY_DEFAULT, /* dataRepresentationQosPolicy */ \
    MIG_RTPS_GUID_UNKNOWN, /* virtualGuid */                             \
    MIG_RTPS_GUID_UNKNOWN, /* groupVirtualGuid */                        \
    PRES_PS_PUBLICATION_PARAMETER_SERVICE_QOS_POLICY_DEFAULT, /* serviceQosPolicy */           \
    MIG_RTPS_PROTOCOL_VERSION, /* protocolVersion */                     \
    MIG_RTPS_VENDOR_ID_UNKNOWN, /* vendorId */                           \
    PRES_PRODUCT_VERSION_DEFAULT, /* productVersion */                   \
    RTI_FALSE, /* isIncompatible */                                      \
    ...
    PRES_TOPIC_QUERY_PUBLICATION_PROPERTY_DEFAULT, /* topicQueryPublicationProperty */                      \
    PRES_ENDPOINT_SECURITY_INFO_DEFAULT, /* securityInfo */              \
    PRES_ENDPOINT_RTI_SECURITY_ATTRIBUTES_BITMASK_DEFAULT /* rtiSecurityAttributes */ \
    }
...
struct PRESPsWriterResourceLimits {
    ...
    /*e immutable.
     */
    struct REDAFastBufferPoolGrowthProperty writerLoanedSampleAllocation;

    /*e immutable.
     */
    RTIBool initializeWriterLoanedSample;
};


#define PRESPsServiceWriterLoanedSampleAllocation_INITIALIZER { \
...
#define PRES_PS_WRITER_PROPERTY_DEFAULT {                     \
    ...
    { /* writerResourceLimits */                    \
      ...
      PRESPsServiceWriterLoanedSampleAllocation_INITIALIZER, \
      RTI_FALSE /* initializeWriterLoanedSample */ \
    }, \
    { /* writerDataLifecycle */                               \
      RTI_TRUE,                                               \
      RTI_NTP_TIME_MAX,                                       \
...
struct PRESPsReaderFragmentationResourceLimits {
    /*e
     * immutable. Determines whether the reader supports receiving fragments
     * samples.
     */
    RTIBool disableFragmentationSupport;

    /*e
     * immutable. The number of fragmented samples for all remote writers.
     * Completely independent from maxSamples (full samples), etc.
     */
    struct REDAFastBufferPoolGrowthProperty fragmentedSamples;

    /*e
     * immutable. The maximum number of fragmented samples for a given remote
     * writer. Completely independent from maxSamples (full samples), etc.
     */
    int maxFragmentedSamplesPerRemoteWriter;

    /*e
     * immutable. The maximum number of fragments for any samples.
     */
    int maxFragmentsPerSample;

    /*e
     * immutable. Pre-allocation means buffers are allocated to max size (can be
...
/*e \ingroup PRESPsServiceModule */
#define PRES_PS_READER_FRAGMENTATION_RESOURCE_LIMITS_DEFAULT { \
...
struct PRESPsReaderResourceLimits {
    ...
    */
    ...
    /*e immutable.
     */
    struct REDAFastBufferPoolGrowthProperty shmemRefTransferModeAttachedSegmentAllocation;
};


#define PRESPsServiceShmemRefTransferModeAttachedSegmentAllocation_INITIALIZER { \
    REDA_FAST_BUFFER_POOL_AUTO, /* initial_count */ \
    REDA_FAST_BUFFER_POOL_AUTO, /* max_count */ \
    REDA_FAST_BUFFER_POOL_AUTO /* incremental_count */ \
}
...
#define PRES_PS_READER_RESOURCE_LIMITS_DEFAULT {              \
    ...
    1, /* maxAppAckResponseLength */ \
    RTI_TRUE, /* keepMinimumStateForInstances */ \
    /* topicQueryCount */ \
    {1, REDA_FAST_BUFFER_POOL_UNLIMITED, REDA_FAST_BUFFER_POOL_UNLIMITED}, \
    PRESPsServiceShmemRefTransferModeAttachedSegmentAllocation_INITIALIZER \
}
...
struct PRESPsReaderListener {
  ...
  #define PRESPsReaderListener_INITIALIZER { \
      NULL, /* onRequestedDeadlineMissed */ \
      NULL, /* onRequestedIncompatibleQos */ \
      NULL, /* onSampleRejected */ \
      NULL, /* onLivelinessChanged */ \
      NULL, /* onSampleLost */ \
      NULL, /* onSubscriptionMatch */ \
      NULL, /* onDataAvailable */ \
      NULL /* onLivelinessUpdated */ \
}
...
struct PRESPsServiceProperty {
    ...
    /*e Maximum number of data tags associated with a data writer */
    int writerMaxDataTagLength;
    /*e Maximum string length of the data tags associated with a data writer.
     *  The string length is defined as the cumulative length in bytes
     *  (not including NULL terminated char) of all
     *  the pair (name, value) associated with the writer data tags.
     */
    int writerMaxDataTagStringLength;
    /*e Maximum number of data tags associated with a data reader */
    int readerMaxDataTagLength;
    /*e Maximum string length of the data tags associated with a data reader.
     *  The string length is defined as the cumulative length in bytes
     *  (not including NULL terminated char) of all
     *  the pair (name, value) associated with the reader data tags.
     */
    int readerMaxDataTagStringLength;
...
/*e \ingroup PRESPsServiceModule
  Default value of maximum length of data tag list
 */
#define PRES_PS_DATA_TAG_LIST_MAXIMUM 0

/*e \ingroup PRESPsServiceModule
  Default value of maximum length of data tag string
 */
#define PRES_PS_DATA_TAG_STRING_MAXIMUM 0
...
#define PRES_PS_SERVICE_PROPERTY_DEFAULT {                         \
 ...
 /* queryConditionPool */              \
    ...
    PRES_PS_DATA_TAG_LIST_MAXIMUM, /* writerMaxDataTagLength */    \
    PRES_PS_DATA_TAG_STRING_MAXIMUM, /* writerMaxDataTagStringLength */ \
    PRES_PS_DATA_TAG_LIST_MAXIMUM, /* readerMaxDataTagLength */    \
    PRES_PS_DATA_TAG_STRING_MAXIMUM, /* readerMaxDataTagStringLength */ \
...
#endif
  #include "pres/pres_psService_impl.h"
