...
/*
 * @(#)pres_psReaderWriter_impl.h    generated by: makeheader    Thu Feb 28 22:12:34 2019
 *
...
/*---------------------------------------------------------------------------*/
#define PRESPsReader_get_cdr_support_mask(reader) \
    ((reader)->_cdrSupportMask)
...
#define PRESPsWriter_get_cdr_support_mask(writer) \
    ((writer)->_cdrSupportMask)
