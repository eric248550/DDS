...
/*
 * @(#)dds_c_infrastructure.h    generated by: makeheader    Thu Feb 28 22:12:55 2019
 *
...
#define DDS_RTPS_GUID_as_guid(rtpsGuid) ((DDS_GUID_t*) rtpsGuid)
#define DDS_GUID_as_rtps_guid(guid) ((DDS_RTPS_GUID_t*) guid)
...
#define DDS_STATUS_MASK_ALL    (~(DDS_StatusMask)DDS_STATUS_MASK_NONE)
...
#define DDS_QOS_POLICY_COUNT 63 /* The count is not including DDS_INVALID_QOS_POLICY_ID */
...
typedef enum {
    ...
    /*e \dref_QosPolicyId_t_DATA_REPRESENTATION_QOS_POLICY_ID
     */
    ...
    /*e \dref_QosPolicyId_t_DATATAG_QOS_POLICY_ID
     */
    DDS_DATATAG_QOS_POLICY_ID = 25,
    ...
    /*e \dref_QosPolicyId_t_DATAWRITERTRANSFERMODE_QOS_POLICY_ID
     */
    DDS_DATAWRITERTRANSFERMODE_QOS_POLICY_ID = 1039
} DDS_QosPolicyId_t;
...
#define DDS_AllocationSettings_t_AUTO { \
        REDA_FAST_BUFFER_POOL_AUTO, /* initial_count */ \
        REDA_FAST_BUFFER_POOL_AUTO, /* max_count */ \
        REDA_FAST_BUFFER_POOL_AUTO /* incremental_count */ \
    }
...
DDSC_VARIABLE_LENGTH_VALUE_TYPE_SUPPORT_W_ERROR_CHECKING(DDS_TransportUnicastSettings_t);
...
DDSC_VARIABLE_LENGTH_VALUE_TYPE_SUPPORT_W_ERROR_CHECKING(DDS_TransportMulticastSettings_t);
...
DDSC_VARIABLE_LENGTH_VALUE_TYPE_SUPPORT_W_ERROR_CHECKING(DDS_TransportMulticastMapping_t);
...
DDS_SEQUENCE(DDS_EncapsulationIdSeq, DDS_EncapsulationId_t);
 ...
 extern DDSCDllVariable const DDS_EncapsulationId_t DDS_ENCAPSULATION_ID_CDR2_BE;

 extern DDSCDllVariable const DDS_EncapsulationId_t DDS_ENCAPSULATION_ID_CDR2_LE;

 extern DDSCDllVariable const DDS_EncapsulationId_t DDS_ENCAPSULATION_ID_CDR2_NATIVE;

 extern DDSCDllVariable const DDS_EncapsulationId_t DDS_ENCAPSULATION_ID_SHMEM_REF_PLAIN;

 extern DDSCDllVariable const DDS_EncapsulationId_t DDS_ENCAPSULATION_ID_SHMEM_REF_FLAT_DATA;


DDSC_VARIABLE_LENGTH_VALUE_TYPE_SUPPORT_W_ERROR_CHECKING(DDS_TransportEncapsulationSettings_t);
...
DDSC_VARIABLE_LENGTH_VALUE_TYPE_SUPPORT_W_ERROR_CHECKING(DDS_Discovery_ParticipantInformation);
...
DDSC_VARIABLE_LENGTH_VALUE_TYPE_SUPPORT_W_ERROR_CHECKING(DDS_Discovery_EndpointInformation);
...
DDS_RTPS_AUTO_ID_FROM_UUID, /* rtps_auto_id_kind */ \
...
DDSC_VARIABLE_LENGTH_VALUE_TYPE_SUPPORT_W_ERROR_CHECKING(DDS_Locator_t);
...
#define DDS_DATA_READER_RESOURCE_LIMITS_QOS_POLICY_DEFAULT { \
    ...
    1L, /* max_app_ack_response_length */ \
...
struct DDS_DataWriterProtocolQosPolicy {
    ...
    */
    ...
    /*e \dref_DataWriterProtocolQosPolicy_initial_virtual_sequence_number
     */
...
struct DDS_DomainParticipantResourceLimitsQosPolicy {
    ...
    /*e \dref_DomainParticipantResourceLimitsQosPolicy_writer_data_tag_list_max_length
     */
    DDS_Long writer_data_tag_list_max_length;

    /*e \dref_DomainParticipantResourceLimitsQosPolicy_writer_data_tag_string_max_length
     */
    DDS_Long writer_data_tag_string_max_length;

    /*e \dref_DomainParticipantResourceLimitsQosPolicy_reader_data_tag_list_max_length
     */
    DDS_Long reader_data_tag_list_max_length;

    /*e \dref_DomainParticipantResourceLimitsQosPolicy_reader_data_tag_string_max_length
     */
...
{{16L, -1L, -1L}, /*local_writer_allocation*/      \
 ...
 0, /* Type code max serialized size */              \
 8192, /* Type object max serialized size */            \
 8192, /* Serialized type object dynamic allocation threshold */       \
 ...
 0, /* writer data tag list max length */ \
 0, /* writer data tag string max length */ \
 0, /* reader data tag list max length */ \
 0, /* reader data tag string max length */ \
 PRES_SHMEM_REF_TRANSFER_MODE_MAX_SEGMENTS /* shmem ref transfer mode max segments */ \
}
...
DDSC_VARIABLE_LENGTH_VALUE_TYPE_SUPPORT_W_ERROR_CHECKING(DDS_TransportInfo_t);
...
struct DDS_DiscoveryConfigQosPolicy {
    ...
    */
    ...
    /*e \dref_DiscoveryConfigQosPolicy_secure_volatile_writer_publish_mode
     */
    struct DDS_PublishModeQosPolicy secure_volatile_writer_publish_mode;

    /*e \dref_DiscoveryConfigQosPolicy_endpoint_type_object_lb_serialization_threshold
     */
...
DDS_PUBLISH_MODE_QOS_POLICY_DEFAULT, /* secure_volatile_writer_publish_mode */\
PRES_PS_ENDPOINT_DISCOVERY_TYPE_OBJECT_LB_SERIALIZATION_THRESHOLD_DEFAULT, /* endpoint_type_object_lb_serialization_threshold */\
...
typedef enum {
    ...
    /*e \dref_TypeConsistencyKind_AUTO_TYPE_COERCION
     */
...
struct DDS_TypeConsistencyEnforcementQosPolicy {
    ...
    */
    ...
    /*e \dref_TypeConsistencyEnforcementQosPolicy_ignore_sequence_bounds
    */
    DDS_Boolean ignore_sequence_bounds;

    /*e \dref_TypeConsistencyEnforcementQosPolicy_ignore_string_bounds
    */
    DDS_Boolean ignore_string_bounds;

    /*e \dref_TypeConsistencyEnforcementQosPolicy_ignore_member_names
    */
    DDS_Boolean ignore_member_names;

    /*e \dref_TypeConsistencyEnforcementQosPolicy_prevent_type_widening
    */
    DDS_Boolean prevent_type_widening;

    /*e \dref_TypeConsistencyEnforcementQosPolicy_force_type_validation
    */
    DDS_Boolean force_type_validation;

    /*e \dref_TypeConsistencyEnforcementQosPolicy_ignore_enum_literal_names
    */
...
#define DDS_TYPE_CONSISTENCY_ENFORCEMENT_QOS_POLICY_DEFAULT { \
    DDS_AUTO_TYPE_COERCION, \
    DDS_BOOLEAN_FALSE, /* ignore_sequence_bounds */ \
    DDS_BOOLEAN_FALSE, /* ignore_string_bounds */ \
    DDS_BOOLEAN_FALSE, /* ignore_member_names */ \
    DDS_BOOLEAN_FALSE, /* prevent_type_widening */ \
    DDS_BOOLEAN_FALSE, /* force_type_validation */ \
    DDS_BOOLEAN_FALSE  /* ignore_enum_literal_names */ \
}
...
DDSC_VARIABLE_LENGTH_VALUE_TYPE_SUPPORT_W_ERROR_CHECKING(DDS_LocatorFilter_t);
...
DDSC_VARIABLE_LENGTH_VALUE_TYPE_SUPPORT_W_ERROR_CHECKING(DDS_ChannelSettings_t);
...
DDS_SEQUENCE(DDS_TagSeq, struct DDS_Tag);

 extern DDSCDllVariable
const char *const DDS_DATATAG_QOS_POLICY_NAME;


DDSC_VARIABLE_LENGTH_VALUE_TYPE_SUPPORT(DDS_DataTags);

struct DDS_DataTags {
    /*e \dref_DataTags_tags
    */
    struct DDS_TagSeq tags;
    
    DDSCPP_VARIABLE_LENGTH_VALUE_TYPE_SUPPORT(DDS_DataTags)
};
...
#define DDS_DATA_TAG_QOS_POLICY_DEFAULT {DDS_SEQUENCE_INITIALIZER}



extern	DDSCDllExport
void DDS_DataTagQosPolicy_save(
        const DDS_DataTagQosPolicy *self,
        const DDS_DataTagQosPolicy *base,
        struct RTIXMLSaveContext *dst);
...
DDSC_VARIABLE_LENGTH_VALUE_TYPE_SUPPORT_W_ERROR_CHECKING(DDS_EndpointGroup_t);
...
typedef DDS_Short DDS_DataRepresentationId_t;
 ...
 extern DDSCDllVariable const DDS_DataRepresentationId_t DDS_XCDR_DATA_REPRESENTATION;

 extern DDSCDllVariable const DDS_DataRepresentationId_t DDS_XML_DATA_REPRESENTATION;

 extern DDSCDllVariable const DDS_DataRepresentationId_t DDS_XCDR2_DATA_REPRESENTATION;

 extern DDSCDllVariable const DDS_DataRepresentationId_t DDS_AUTO_DATA_REPRESENTATION;


DDS_SEQUENCE(DDS_DataRepresentationIdSeq, DDS_DataRepresentationId_t);


DDSC_VARIABLE_LENGTH_VALUE_TYPE_SUPPORT(DDS_DataRepresentationQosPolicy);

 extern DDSCDllVariable const char *const 
DDS_DATA_REPRESENTATION_QOS_POLICY_NAME;

struct DDS_DataRepresentationQosPolicy {
    /*e \dref_DataRepresentationQosPolicy_value
    */
    struct DDS_DataRepresentationIdSeq value;
    DDSCPP_VARIABLE_LENGTH_VALUE_TYPE_SUPPORT(DDS_DataRepresentationQosPolicy)
};


#define DDS_DataRepresentationQosPolicy_INITIALIZER { \
    DDS_SEQUENCE_INITIALIZER /* value */\
}

typedef enum {
    /*i \dref_DataRepresentationMaskBits_XCDR_DATA_REPRESENTATION_BIT
     */
    DDS_XCDR_DATA_REPRESENTATION_BIT = (0x00000001 << 0),
    /*i \dref_DataRepresentationMaskBits_EXTENSIBLE_EXTENSIBILITY_BIT
     */
    DDS_XML_DATA_REPRESENTATION_BIT = (0x00000001 << 1),
    /*i \dref_DataRepresentationMaskBits_MUTABLE_EXTENSIBILITY_BIT
     */
    DDS_XCDR2_DATA_REPRESENTATION_BIT = (0x00000001 << 2)
} DDS_DataRepresentationMaskBits;

typedef DDS_Long DDS_DataRepresentationMask;


#define DDS_DATA_REPRESENTATION_MASK_DEFAULT \
    (DDS_XCDR_DATA_REPRESENTATION_BIT|DDS_XCDR2_DATA_REPRESENTATION_BIT)

extern DDSCDllExport
DDS_Boolean DDS_DataRepresentationQosPolicy_contains(
        const struct DDS_DataRepresentationQosPolicy *self,
        DDS_DataRepresentationId_t representation_id);

extern DDSCDllExport
DDS_Boolean DDS_DataRepresentationQosPolicy_equals(
        const struct DDS_DataRepresentationQosPolicy *left,
        const struct DDS_DataRepresentationQosPolicy *right);

extern DDSCDllExport
void DDS_DataRepresentationQosPolicy_save(
        const struct DDS_DataRepresentationQosPolicy *self,
        const struct DDS_DataRepresentationQosPolicy *base,
        struct RTIXMLSaveContext *dst);
...
extern DDSCDllExport
RTIEncapsulationId DDS_DataRepresentationQosPolicy_getNativeEncapsulationWithRepresentationMask(
        DDS_DataRepresentationId_t representation_id,
        DDS_DataRepresentationMask allowed_data_representation);

extern DDSCDllExport
DDS_DataRepresentationId_t DDS_DataRepresentationQosPolicy_resolve_data_representation_id(
        DDS_DataRepresentationId_t selected_data_representation,
        DDS_DataRepresentationMask allowed_data_representation);
...
extern DDSCDllExport
DDS_Boolean DDS_DataWriterShmemRefTransferModeSettings_equals(
        const struct DDS_DataWriterShmemRefTransferModeSettings *left,
        const struct DDS_DataWriterShmemRefTransferModeSettings *right);
...
extern DDSCDllExport void*
DDS_Cookie_to_pointer(const struct DDS_Cookie_t* self);
