...
/*
 * @(#)dds_c_infrastructure_impl.h    generated by: makeheader    Thu Feb 28 22:12:55 2019
 *
...
extern DDSCDllExport void* DDS_Entity_get_reserved_cxx_dataI(DDS_Entity* self);

extern DDSCDllExport DDS_ReturnCode_t DDS_Entity_set_reserved_cxx_dataI(DDS_Entity* self, void* reserved_data);
...
extern DDSCDllExport
DDS_Boolean DDS_DataTagQosPolicy_equals(
        const DDS_DataTagQosPolicy *left,
        const DDS_DataTagQosPolicy *right);
...
extern DDSCDllExport
RTIBool DDS_StringSeq_from_string_array(
