...
/*
 * @(#)dds_c_sequence.h    generated by: makeheader    Thu Feb 28 22:12:55 2019
 *
...
#define DDS_SEQUENCE_COPY_METHODS(TSeq, T) \
...
/*ci @ingroup DDSSequenceModule
  @brief    Sequence copy method in C
*/
#define DDS_SEQUENCE_GET_METHOD_IN_C(TSeq, T) \
; \
...
#define DDS_SEQUENCE_COPY_METHODS_IN_C(TSeq, T) \
; \
NDDSUSERDllExport DDSCDllExport                                        \
...
DDS_SEQUENCE_COPY_METHODS(TSeq, T) \
}                              \
DDS_SEQUENCE_METHODS_IN_C(TSeq, T) \
DDS_SEQUENCE_COPY_METHODS_IN_C(TSeq, T)

#define DDS_SEQUENCE_FLAT_DATA(TSeq, T)   \
struct DDS_SEQUENCE_DLL_EXPORT TSeq { \
DDS_SEQUENCE_MEMBERS(TSeq, T)   \
DDS_SEQUENCE_METHODS(TSeq, T)   \
}                              \
