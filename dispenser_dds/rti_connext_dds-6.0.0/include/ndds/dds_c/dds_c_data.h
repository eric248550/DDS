...
/*
 * @(#)dds_c_data.h    generated by: makeheader    Thu Feb 28 22:12:55 2019
 *
 *		built from:	data.ifc
 */
...
#define DDS_DATAWRITER_WITH_DATA_CONSTRUCTOR_METHODS_C(TDataWriter, TData)   \
    DDS_DATAWRITER_C(TDataWriter, TData);                                 \
    NDDSUSERDllExport DDSCDllExport                                       \
    TData* TDataWriter ## _create_data(                                   \
        TDataWriter* writer);                                             \
    NDDSUSERDllExport DDSCDllExport                                       \
    TData* TDataWriter ## _create_data_w_params(                          \
            TDataWriter* writer,                                          \
            const struct DDS_TypeAllocationParams_t * alloc_params);      \
    NDDSUSERDllExport DDSCDllExport                                       \
    DDS_Boolean TDataWriter ## _delete_data(TDataWriter* writer, TData*); \
    NDDSUSERDllExport DDSCDllExport                                       \
    DDS_Boolean TDataWriter ## _delete_data_w_params(                     \
            TDataWriter* writer,                                          \
            TData*,                                                       \
            const struct DDS_TypeDeallocationParams_t*);                  \
    NDDSUSERDllExport DDSCDllExport                                       \
    DDS_ReturnCode_t TDataWriter ## _get_loan(                            \
            TDataWriter* writer, TData** sample);                         \
    NDDSUSERDllExport DDSCDllExport                                       \
...
#define DDS_DATAREADER_C(TDataReader, TDataSeq, TData)                       \
    ...
    DDS_InstanceHandle_t TDataReader ## _lookup_instance(                    \
        TDataReader* self, const TData* key_holder);                         \
                                                                             \
    NDDSUSERDllExport DDSCDllExport                                          \
    DDS_ReturnCode_t TDataReader ## _is_data_consistent(                     \
        TDataReader *self,                                                   \
