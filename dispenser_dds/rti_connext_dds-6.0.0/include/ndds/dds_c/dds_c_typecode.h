...
/*
 * @(#)dds_c_typecode.h    generated by: makeheader    Thu Feb 28 22:12:56 2019
 *
...
typedef struct RTIXCdrTypeCodeAnnotations DDS_TypeCode_Annotations;
...
struct DDS_TYPECODE_DLL_EXPORT DDS_TypeCode {
    ...
    /*e \dref_TypeCode_get_cdr_serialized_sample_max_size */
    DDS_UnsignedLong get_cdr_serialized_sample_max_size(
...
typedef enum {
    /* Regular typecode without optimizations. */
    DDS_TYPECODE_OPTIMIZATION_LEVEL_NONE,
    /*
     * This optimization will trigger the creation of indexes that allow for a
     * faster access to member-ids.
     */
    DDS_TYPECODE_OPTIMIZATION_LEVEL_INDEXED,
    /*
     * This optimization will trigger the creation of indexes that allow for a
     * faster access to member-ids and it will remove pointers.
     */
    DDS_TYPECODE_OPTIMIZATION_LEVEL_CDR_OPTIMIZED
} DDS_TypeCodeOptimizationLevel;


typedef struct DDS_TypeCodeHandle {
    DDS_TypeCode *tc;
    RTIOsapiHash hash;
...
#define DDS_TypeCodeHandle_INITIALIZER { \
    NULL, \
    RTI_OSAPI_HASH_NIL, \
...
struct DDS_TYPECODE_DLL_EXPORT DDS_TypeCodeFactory {
    /*i
     * @brief Mutex used to protect the global tc and programs lists.
     */
    struct RTIOsapiSemaphore *_mutex;

    /*i
     * @brief Description for the global tc and programs lists.
     */
    struct REDASkiplistDescription _tcListsDescription;

    /*i
     * @brief Pool for getting tcList nodes.
     */
    struct REDAFastBufferPool *_tcListPool;

    /*i
     * @brief Pool for getting programsList nodes.
     */
    struct REDAFastBufferPool *_tcProgramsListPool;

    /*i
     * @brief List of typecodes shared across domain participant factories.
     */
    struct REDASkiplist _tcList;

    /*i
     * @brief List of programs shared across domain participant factories.
     */
    struct REDASkiplist _tcProgramsList;

    /*i
     * @brief Factory used to convert tc to type objects.
     */
    struct RTICdrTypeObjectFactory *_typeObjectFactory;
...
extern DDSCDllExport DDS_DataRepresentationMask DDS_TypeCode_data_representation_mask(
        const DDS_TypeCode *self,
        DDS_ExceptionCode_t *ex);

extern DDSCDllExport DDS_Boolean DDS_TypeCode_is_flat_data_language_binding(
        const DDS_TypeCode *self,
        DDS_ExceptionCode_t *ex);

extern DDSCDllExport DDS_Boolean DDS_TypeCode_is_shmem_ref_transfer_mode(
        const DDS_TypeCode *self,
        DDS_ExceptionCode_t *ex);
...
const DDS_TypeCode_Annotations *DDS_TypeCode_annotations(
        const DDS_TypeCode *self,
        DDS_ExceptionCode_t *ex);

extern DDSCDllExport
const DDS_TypeCode_Annotations *DDS_TypeCode_member_annotations(
        const DDS_TypeCode *self,
        DDS_UnsignedLong index,
        DDS_ExceptionCode_t *ex);
...
extern DDSCDllExport 
DDS_TypeCode * DDS_TypeCodeFactory_clone_tc_optimizedI(
        DDS_TypeCodeFactory *self,
        const DDS_TypeCode *tc,
        DDS_Boolean minimalTc,
        DDS_ExceptionCode_t *ex);

extern DDSCDllExport
DDS_TypeCode *DDS_TypeCodeFactory_clone_tc_w_optimization_level(
        DDS_TypeCodeFactory *self,
        const DDS_TypeCode *tc,
        DDS_TypeCodeOptimizationLevel optimization_level,
        DDS_ExceptionCode_t *ex);
