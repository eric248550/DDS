...
/*
 * @(#)dds_c_subscription.h    generated by: makeheader    Thu Feb 28 22:12:56 2019
 *
...
typedef enum {
    ...
    */
    ...
    /*e \dref_SampleLostStatusKind_LOST_BY_UNKNOWN_INSTANCE
     */
...
typedef enum {
    ...
    */
    ...
    /*e \dref_SampleRejectedStatusKind_REJECTED_BY_UNKNOWN_INSTANCE
     */
...
struct DDS_DataReaderCacheStatus {
    ...
    /*i \dref_DataReaderCacheStatus_instance_count
     */
    DDS_LongLong instance_count;
    /*i \dref_DataReaderCacheStatus_instance_count_peak
     */
    DDS_LongLong instance_count_peak;
};
...
struct DDSCPPDllExport DDS_SampleInfo {
    ...
    */
    ...
    /*i \dref_SampleInfo_encapsulation_id
     */
    DDS_EncapsulationId_t encapsulation_id;

    /*i \dref_SampleInfo_related_epoch
     */
...
struct DDS_DataReaderQos {
    ...
    */
    ...
    /*e \dref_DataReaderQos_data_tags
     */
...
extern DDSCDllExport DDS_ReturnCode_t DDS_DataReader_get_listenerX(
        DDS_DataReader* self,
        struct DDS_DataReaderListener* listener);

extern DDSCDllExport DDS_ReturnCode_t DDS_DataReader_get_listenerXI(
        DDS_DataReader* self,
        struct DDS_DataReaderListener* listener);
...
typedef enum {
    /*e \dref_TopicQuerySelectionKind_HISTORY_SNAPSHOT
     */
    DDS_TOPIC_QUERY_SELECTION_KIND_HISTORY_SNAPSHOT = 0,
    /*e \dref_TopicQuerySelectionKind_CONTINUOUS
     */
...
typedef struct DDS_TopicQuerySelection {
    ...
    /*e \dref_TopicQuerySelection_kind
     */
