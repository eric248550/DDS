...
/*
 * @(#)dds_c_publication_impl.h    generated by: makeheader    Thu Feb 28 22:12:55 2019
 *
...
extern DDSCDllExport DDS_ReturnCode_t DDS_DataWriter_get_loan_untypedI(
        DDS_DataWriter *self,
        void **data,
        DDS_Boolean *initialize_data);

extern DDSCDllExport DDS_ReturnCode_t DDS_DataWriter_discard_loan_untypedI(
        DDS_DataWriter *self,
        void *data);

extern DDSCDllExport DDS_Boolean DDS_DataWriter_is_initialize_writer_loaned_sample(
        DDS_DataWriter *self);
...
DDS_Boolean DDS_DataWriter_is_instance_handle_compatibleI(
        DDS_DataWriter *self,
        const DDS_InstanceHandle_t *handle);
...
extern DDSCDllExport
DDS_ReturnCode_t DDS_DataWriter_is_xcdr2I(
        DDS_DataWriter *self,
        DDS_Boolean *is_xcdr2);
...
extern DDSCDllExport
DDS_ReturnCode_t DDS_DataWriterQos_get_defaultI(struct DDS_DataWriterQos *self);
