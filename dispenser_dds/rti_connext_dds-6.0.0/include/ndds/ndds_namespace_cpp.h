...
/*
 * @(#)ndds_namespace_cpp.h    generated by: makeheader    Thu Feb 28 22:13:03 2019
 *
...
namespace DDS {
    ...
    extern DDSCPPDllVariable const DDS_Long         &AUTO_COUNT;
    ...
    extern DDSCPPDllVariable const DDS_ReturnCode_t RETCODE_NOT_ALLOWED_BY_SECURITY;
    ...
    extern DDSCPPDllVariable const char *const &DATATAG_QOS_POLICY_NAME;
    ...
    extern DDSCPPDllVariable const char *const &DATA_REPRESENTATION_QOS_POLICY_NAME;
    extern DDSCPPDllVariable const char *const &DATAWRITERTRANSFERMODE_QOS_POLICY_NAME;
    ...
    extern DDSCPPDllVariable const DDS_QosPolicyId_t DATATAG_QOS_POLICY_ID;
    ...
    extern DDSCPPDllVariable const DDS_QosPolicyId_t DATA_REPRESENTATION_QOS_POLICY_ID;
    extern DDSCPPDllVariable const DDS_QosPolicyId_t DATAWRITERTRANSFERMODE_QOS_POLICY_ID;
    ...
    typedef DDS_DataWriterTransferModeQosPolicy DataWriterTransferModeQosPolicy;
    ...
    typedef DDS_DataRepresentationId_t      DataRepresentationId_t;
    extern DDSCPPDllVariable const DataRepresentationId_t &XCDR_DATA_REPRESENTATION;
    extern DDSCPPDllVariable const DataRepresentationId_t &XML_DATA_REPRESENTATION;
    extern DDSCPPDllVariable const DataRepresentationId_t &XCDR2_DATA_REPRESENTATION;
    extern DDSCPPDllVariable const DataRepresentationId_t &AUTO_DATA_REPRESENTATION;
    typedef DDS_DataRepresentationIdSeq     DataRepresentationIdSeq;
    ...
    typedef DDSDataTagQosPolicyHelper      DataTagQosPolicyHelper;
    ...
    extern DDSCPPDllVariable const DDS_TypeConsistencyKind AUTO_TYPE_COERCION;
    ...
    typedef DDS_TopicQuerySelectionKind TopicQuerySelectionKind;
    extern DDSCPPDllVariable const TopicQuerySelectionKind
        TOPIC_QUERY_SELECTION_KIND_HISTORY_SNAPSHOT;
    extern DDSCPPDllVariable const TopicQuerySelectionKind
        TOPIC_QUERY_SELECTION_KIND_CONTINUOUS;
...
/* *********************** BuiltinQosProfilesLibrary *********************** */
    ...
    extern DDSCPPDllVariable const char *const &PROFILE_BASELINE_6_0_0;
