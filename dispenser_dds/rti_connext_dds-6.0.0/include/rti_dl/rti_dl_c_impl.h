...
/*
 * @(#)rti_dl_c_impl.h    generated by: makeheader    Thu Feb 28 22:13:59 2019
 *
...
struct RTI_DL_Options {
    ...
    /*i
     * If this field is not null, this is the C++ DomainParticipant that will
     * be used to create the C++ wrappers around the DL Topics. The default
     * value is NULL. This value is populated during the C++
     * setDomainParticipant. This field is a void* because this is a C header
     * file, and we cannot use DDSDomainParticipant, which is a C++ class.
     */
    void *cppDomainParticipant;
