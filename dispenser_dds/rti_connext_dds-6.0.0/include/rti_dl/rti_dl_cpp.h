...
/*
 * @(#)rti_dl_cpp.h    generated by: makeheader    Thu Feb 28 22:13:59 2019
 *
...
public:
   ...
   /*e
     ...
     * stdout. The default value is TRUE.
     ...
     *
     * If true, messages produced by either the middleware or the tools will
     * be forwarded to Distributed Logger. In this mode Distributed Logger uses
     * NDDS_Config_Logger_set_output_device() API to receive messages from the
     * middleware. Hence any device previously registered with NDDSConfigLogger's
     * set_output_device() API will be unregistered. Similarly Distributed
     * Logger will stop logging infrastructure messages if the
     * set_output_device() API is used to register a new device after the
     * creation of the Distributed Logger instance.
     *
...
public:
     ...
     *  \return     RTI_TRUE if everything went as planned. RTI_FALSE if RTI
     *  Distributed Logger already existed.
     */
    ...
    /*e 
     *  \brief Performs the same function as \ref logMessageWithLevelCategory
