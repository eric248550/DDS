...
src/libmongoc/CMakeFiles/example-command-with-opts.dir/examples/example-command-with-opts.c.o: ../src/libmongoc/examples/example-command-with-opts.c
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/home/xinxing06/DDS/mongo-c-driver-1.17.3/cmake-build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building C object src/libmongoc/CMakeFiles/example-command-with-opts.dir/examples/example-command-with-opts.c.o"
	cd /home/xinxing06/DDS/mongo-c-driver-1.17.3/cmake-build/src/libmongoc && /usr/bin/cc $(C_DEFINES) $(C_INCLUDES) $(C_FLAGS) -o CMakeFiles/example-command-with-opts.dir/examples/example-command-with-opts.c.o   -c /home/xinxing06/DDS/mongo-c-driver-1.17.3/src/libmongoc/examples/example-command-with-opts.c
...
src/libmongoc/CMakeFiles/example-command-with-opts.dir/examples/example-command-with-opts.c.i: cmake_force
	...
	cd /home/xinxing06/DDS/mongo-c-driver-1.17.3/cmake-build/src/libmongoc && /usr/bin/cc $(C_DEFINES) $(C_INCLUDES) $(C_FLAGS) -E /home/xinxing06/DDS/mongo-c-driver-1.17.3/src/libmongoc/examples/example-command-with-opts.c > CMakeFiles/example-command-with-opts.dir/examples/example-command-with-opts.c.i
...
src/libmongoc/CMakeFiles/example-command-with-opts.dir/examples/example-command-with-opts.c.s: cmake_force
	...
	cd /home/xinxing06/DDS/mongo-c-driver-1.17.3/cmake-build/src/libmongoc && /usr/bin/cc $(C_DEFINES) $(C_INCLUDES) $(C_FLAGS) -S /home/xinxing06/DDS/mongo-c-driver-1.17.3/src/libmongoc/examples/example-command-with-opts.c -o CMakeFiles/example-command-with-opts.dir/examples/example-command-with-opts.c.s
...
src/libmongoc/example-command-with-opts: /usr/lib/arm-linux-gnueabihf/libsasl2.so
src/libmongoc/example-command-with-opts: /usr/lib/arm-linux-gnueabihf/libssl.so
src/libmongoc/example-command-with-opts: /usr/lib/arm-linux-gnueabihf/libcrypto.so
src/libmongoc/example-command-with-opts: /usr/lib/arm-linux-gnueabihf/libz.so
...
src/libmongoc/example-command-with-opts: src/libmongoc/CMakeFiles/example-command-with-opts.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/home/xinxing06/DDS/mongo-c-driver-1.17.3/cmake-build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking C executable example-command-with-opts"
	cd /home/xinxing06/DDS/mongo-c-driver-1.17.3/cmake-build/src/libmongoc && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/example-command-with-opts.dir/link.txt --verbose=$(VERBOSE)
...
src/libmongoc/CMakeFiles/example-command-with-opts.dir/clean:
	cd /home/xinxing06/DDS/mongo-c-driver-1.17.3/cmake-build/src/libmongoc && $(CMAKE_COMMAND) -P CMakeFiles/example-command-with-opts.dir/cmake_clean.cmake
